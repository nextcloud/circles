...
class Application extends App {
	...
	public function registerHooks() {
		...
		Util::connectHook(
			'OCA\Circles', 'post_inviteMember', '\OCA\Circles\Hooks\UserHooks', 'onMemberInvited'
		);
		Util::connectHook(
			'OCA\Circles', 'post_leftMember', '\OCA\Circles\Hooks\UserHooks', 'onMemberLeft'
		);
		Util::connectHook(
			'OCA\Circles', 'post_cancelInvitationMember', '\OCA\Circles\Hooks\UserHooks', 'onMemberInvitationCancelled'
		);
		Util::connectHook(
