 ...
 */
class TeamMembership extends Entity implements JsonSerializable {
	...
	public function __construct(
		...
		$this->addType('inheritance_first', 'string');
		$this->addType('inheritance_last', 'string');
		$this->addType('inheritance_depth', 'integer');
		$this->addType('inheritance_path', 'json');
	}
