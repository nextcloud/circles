...
class UserHooks {
	...
	public static function onMemberInvited($params) {
		self::getController()
		->onMemberInvited($params);
	}
	...
	public static function onMemberInvitationCancelled($params) {
		self::getController()
		->onMemberInvitationCancelled($params);
	}
