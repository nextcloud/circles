OC.L10N.register(
    ...
    "Contact" : "Contacto",
    "Kick this member" : "Expulsar a este membro",
    ...
    "On events happening in a <strong>Circle</strong> you belong" : "En eventos que ocorren nun <strong>Círculo</strong> ao que pertence vostede",
    ...
    "You cannot use the Circles Application until your administrator has allowed at least one type of circles" : "Vostede non pode usar o aplicativo «Circles» ata que o administrador teña permitido polo menos un tipo de círculo",
    "Federated link not found" : "Non se atopou a ligazón federada",
    "This member does not exist" : "Non existe este membro",
    "This user is already a member of the circle" : "Este usuario xa é membro do círculo",
    ...
    "The user is already a member of this circle" : "Este usuario xa é membro deste círculo",
    ...
    "The remote host is down or the Circles app is not installed on it" : "A máquina remota está caída ou non ten instalado o aplicativo Círculos.",
    ...
    "Select a circle type" : "Seleccione o tipo de círculo",
    ...
    "Maximum number of members per circle" : "Número máximo de membros dun círculo.",
    ...
    "Members limit:" : "Límite de membros:",
    "Default limit to the number of members in a circle." : "Límite predeterminado ao número de membros dun círculo.",
    "Allow linking of groups:" : "Permitir a ligazón de grupos:",
    "Allow federated circles:" : "Permitir os círculos federados:"
},
