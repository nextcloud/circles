OC.L10N.register(
    ...
    "Hidden circle" : "Círculo agochado",
    ...
    "You have successfully joined this circle" : "Uniuse satisfactoriamente a este círculo",
    "You have requested to join this circle" : "Solicitou unirse a este círculo",
    "You have successfully left this circle" : "Deixou satisfactoriamente este círculo",
    "Cannot leave this circle" : "Non pode deixar este círculo",
    "You have successfully deleted this circle" : "Vostede eliminou satisfactoriamente este círculo",
    ...
    "Member '{name}' successfully added to the circle" : "«{name}» foi engadido satisfactoriamente como participante do círculo",
    "Member '{name}' could not be added to the circle" : "Non foi posíbel engadir a «{name}» como participante no círculo",
    "Member '{name}' successfully removed from the circle" : "«{name}» foi retirado satisfactoriamente como participante no círculo",
    "Member '{name}' could not be removed from the circle" : "Non foi posíbel retirar ao participante no circulo «{name}»",
    "Member '{name}' updated" : "Foi actualizado o participante «{name}»",
    "Member '{name}' could not be updated" : "Non foi posíbel actualizar ao participante no círculo «{name}»",
    "Circles" : "Círculos",
    "The name of your circle must contain at least 3 characters" : "O nome do seu círculo debe conter cando menos 3 caracteres",
    "The name of your circle cannot start with this character" : "O nome do seu círculo non pode comezar por ese carácter",
    ...
    "The circle does not exist or is hidden" : "Non existe o círculo ou está agochado",
    ...
    "This option is not available for personal circles" : "Esta opción non está dispoñíbel para círculos persoais",
    ...
    "Not enough privileges" : "Non ten privilexios abondo",
    "This member is not the owner of the circle" : "Este participante non é o propietario do círculo",
    "This member is not admin of the circle" : "Este participante non é o administrador do círculo",
    ...
    "It seems that you are trying to link a circle to itself" : "Semella que tenta enlazar un círculo consigo mesmo",
    ...
    "Select a type of circle" : "Seleccione o tipo de círculo",
    "Create a personal circle" : "Crear un círculo persoal",
    "Create an hidden circle" : "Crear un círculo agochado",
    ...
    "This is the right option if you want to do recurrent sharing with the same group." : "Esta é a opción indicada se quere compartir frecuentemente co mesmo grupo. ",
    "An hidden circle is an open group that can be protected by a password." : "Un círculo agochado é un grupo aberto que pode ser protexido por un contrasinal.",
    "Users won't be able to find this circle using the Nextcloud search engine." : "Os usuarios non poderán atopar este círculo usando o motor de buscas do Nexcloud. ",
    "A private circle requires invitation or confirmation by an admin." : "Un círculo privado require un convite ou unha confirmación dun administrador.",
    "This is the right circle if you are looking for privacy when sharing your files or ideas." : "Esta é a opción indicada se busca intimidade ao compartir os seus ficheiros ou ideas",
    ...
    "Everyone will be able to see and join your circle." : "Todo o mundo será quen de ver e unirse ao seu círculo.",
    "personal circles" : "círculos persoais",
    "hidden circles" : "círculos agochados",
