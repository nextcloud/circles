OC.L10N.register(
    ...
    "You unlinked {group} from {circle}" : "Vde. desligou {group} de {circle}",
    "{group} has been unlinked from {circle} by {author}" : "{group} foi desligado de {circle} por {author}",
    "You changed the level of the linked group {group} in {circle} to %1$s" : "Vde. cambiou o nivel do grupo ligado {group} en {circle} a %1$s",
    ...
    "You sent a request to link {circle} with {remote}" : "Vde. enviou unha solicitude para ligar {circle} con {remote}",
    ...
    "You dismissed the request to link {remote} with {circle}" : "Vde. rexeitou a solicitude para ligar {remote} con {circle}",
    "{author} dismissed the request to link {remote} with {circle}" : "{author} rexeitou a solicitude para ligar {remote} con {circle}",
    "You canceled the request to link {circle} with {remote}" : "Vde. cancelou a solicitude para ligar {circle} con {remote}",
    "{author} canceled the request to link {circle} with {remote}" : "{author} cancelou a solicitude para ligar {circle} con {remote}",
    "You accepted the request to link {remote} with {circle}" : "Vde. aceptou a solicitude para ligar {remote} con {circle}",
    ...
    "You closed the link between {circle} and {remote}" : "Vde. pechou a ligazón entre {circle} e {remote}",
