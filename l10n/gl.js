OC.L10N.register(
    ...
    "You are now a member of the Circle \"%2$s\"" : "Vostede agora é membro do círculo «%2$s»",
    "%1$s sent a request to be a member of the Circle \"%2$s\"" : "%1$s enviou unha solicitude para ser membro do círculo «%2$s»",
    "Accept" : "Aceptar",
    "Refuse" : "Rexeitar",
    ...
    "You cannot add a mail address as member of your Circle" : "Non pode engadir un enderezo de correo como membro do seu círculo",
    ...
    "A secret circle is an hidden group that can only be seen by its members or by people knowing the exact name of the circle." : "Un círculo segredo é un grupo agochado que só pode ser visto polos seus membros ou persoas que coñecen o nome exacto do círculo.",
    "Non-members won't be able to find your secret circle using the search bar." : "Quen non sexa membro non poderá atopar o seu círculo segredo usando a barra de busca.",
