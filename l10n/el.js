OC.L10N.register(
    ...
    "You have been blocked from this team" : "Σας έχει απαγορευτεί η πρόσβαση σε αυτή την ομάδα",
    "The account is already a member of this team" : "Ο λογαριασμός είναι ήδη μέλος αυτής της ομάδας",
    "The account has already been invited into this team" : "Έχει ήδη αποσταλεί πρόσκληση σε αυτόν τον λογαριασμό για αυτή την ομάδα",
