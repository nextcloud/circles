OC.L10N.register(
    ...
    "You were added as member to {circle} by {author}" : "Έχετε προστεθεί ως μέλος στο {circle} από {author}",
    "{member} was added as member to {circle} by {author}" : "{member} προστέθηκε ως μέλος στο {circle} από {author}",
    ...
    "You were removed from {circle} by {author}" : "Απομακρυνθήκατε από {circle} από {author}",
    "{member} was removed from {circle} by {author}" : "{member} απομακρύνθηκε από {circle} από {author}",
    "You invited {member} into {circle}" : "Προσκαλέσατε {member} σε {circle}",
    "You have been invited into {circle} by {author}" : "Έχετε προσκληθεί σε {circle} από {author}",
    "{member} have been invited into {circle} by {author}" : "{member} προσκλήθηκε σε {circle} από {author}",
    ...
    "You requested an invitation into {circle}" : "Ζητήσατε μια πρόσκληση σε {circle}",
    "{member} has requested an invitation into {circle}" : "{member} αιτήθηκε μια πρόσκληση σε {circle}",
    ...
    "This option is not available for personal circles" : "Αυτή η επιλογή δεν είναι διαθέσιμη για προσωπικούς κύκλους",
    ...
    "Not enough privileges" : "Μη επαρκή δικαιώματα",
    "This member is not the owner of the circle" : "Αυτό το μέλος δεν είναι ο ιδιοκτήτης του κύκλου",
    "This member is not admin of the circle" : "Αυτό το μέλος δεν είναι διαχειριστής του κύκλου",
    ...
    "The remote circle does not accept federated links" : "Ο απομακρυσμένος κύκλος δεν δέχεται ομόσπονδους συνδέσμους",
    "It seems that you are trying to link a circle to itself" : "Φαίνεται ότι προσπαθείτε να συνδέσετε έναν κύκλο με τον εαυτό του",
    ...
    "Create a hidden circle" : "Δημιουργήστε ένα κρυφό κύκλο",
    ...
    "This is the right option if you want to do recurrent sharing with the same group." : "Αυτή είναι η σωστή επιλογή εάν θέλετε να κάνετε επαναλαμβανόμενη κοινή χρήση με την ίδια ομάδα.",
    "An hidden circle is an open group that can be protected by a password." : "Ένας κρυφός κύκλος είναι μια ανοιχτή ομάδα που μπορεί να προστατευθεί με ένα συνθηματικό.",
    "Users won't be able to find this circle using the Nextcloud search engine." : "Οι χρήστες δεν θα είναι σε θέση να βρουν αυτό τον κύκλο χρησιμοποιώντας τη μηχανή αναζήτησης.",
    "A private circle requires invitation or confirmation by an admin." : "Ένας ιδιωτικός κύκλος απαιτεί πρόσκληση ή επιβεβαίωση από ένα διαχειριστή.",
    "This is the right circle if you are looking for privacy when sharing your files or ideas." : "Αυτός είναι ο κατάλληλος κύκλος εάν αναζητάτε ιδιωτικότητα όταν διαμοιράζετε τα αρχεία σας ή τις ιδέες σας.",
    ...
    "Everyone will be able to see and join your circle." : "Οποιοσδήποτε θα είναι σε θέση να δει και να συμμετάσχει στον κύκλο σας.",
    ...
    "Turns the circle as Federated and enable sharing between Federated Circles" : "Μετατρέπει τον κύκλο σε Ομόσπονδο και ενεργοποιεί το διαμοιρασμό μεταξύ Ομόσπονδων Κύκλων",
    "Automatically Accept Link Request" : "Αυτόματη Αποδοχή Αιτημάτων Συνδέσμων",
    "Warning: enabling this will automatically accept new link requests from other circle." : "Προσοχή: ενεργοποιώντας αυτό θα γίνεται αυτόματη αποδοχή νέων αιτημάτων για συνδέσμους από άλλους κύκλους.",
