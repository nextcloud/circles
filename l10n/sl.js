OC.L10N.register(
    ...
    "Create a closed circle" : "Ustvari zaprt krog",
    "Create a secret circle" : "Ustvari skrivni krog",
    ...
    "A secret circle is an hidden group that can only be seen by its members or by people knowing the exact name of the circle." : "Skrivni krog je skrita skupina, ki jo lahko vidijo le člani te skupine in pa osebe, ki poznajo natančno ime kroga.",
    "Non-members won't be able to find your secret circle using the search bar." : "Osebe, ki niso člani, ne bodo našle skrivnega kroga z uporabo iskalnika.",
    "Joining a closed circle requires an invitation or confirmation by a moderator." : "Zaprt krog zahteva povabilo ali pa potrditev moderatorja kroga.",
