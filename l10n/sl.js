OC.L10N.register(
    ...
    "A link to <b>{remote}</b> has been requested." : "Prejeta je zahteva za povezavo s krogom <b>{remote}</b> .",
    ...
    "You dismissed the request to link {remote} with {circle}" : "Opustite zahtevo za povezavo {remote} s krogom {circle}",
    "{author} dismissed the request to link {remote} with {circle}" : "{author} opusti zahtevo za povezavo {remote} s krogom {circle}",
    ...
    "You cannot edit level in a personal circle" : "Ni mogoče urediti ravni v osebnem krogu",
