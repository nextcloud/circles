OC.L10N.register(
    ...
    "A link between {circle} and {remote} is now up and running" : "Povezava med krogom {circle} in {remote} je sedaj omogočena",
    ...
    "You closed the link between {circle} and {remote}" : "Zaprete povezavo med krogom {circle} in {remote}",
    ...
    "{member} is the new owner of {circle}" : "{member} poostane novi lastnik kroga {circle}",
    ...
    "You have a pending request to join this circle" : "Prejeli ste prošnjo za pridruženje v ta krog",
