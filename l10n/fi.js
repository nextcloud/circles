OC.L10N.register(
    ...
    "You have successfully deleted this circle" : "Olet onnistuneesti poistanut tämän piirin",
    ...
    "Member '{name}' could not be added to the circle" : "Jäsentä '{name}' ei voitu lisätä piiriin",
    "Member '{name}' successfully removed from the circle" : "Jäsen '{name}' poistettiin piiristä onnistuneesti",
    "Member '{name}' could not be removed from the circle" : "Jäsentä '{name}'  ei voitu poistaa piiristä",
    ...
    "You requested an invitation to {circle}" : "Pyysit kutsua piiriin {circle}",
    ...
    "The circle does not exist or is hidden" : "Piiriä ei löydy tai se on piilotettu",
    ...
    "This option is not available for personal circles" : "Tämä valinta ei ole avoinna henkilökohtaisissa piireissä",
    ...
    "This is the right option if you want to do recurrent sharing with the same group." : "Käytä tätä, jos haluat tehdä uusiutuvan jaon saman ryhmän kanssa.",
    ...
    "Users won't be able to find this circle using the Nextcloud search engine." : "Tätä piiriä ei voi löytää Nexcloudin hakua käyttäen.",
    "A private circle requires invitation or confirmation by an admin." : "Yksityinen piiri vaatii kutsun tai vahvistuksen ylläpitäjältä.",
    "This is the right circle if you are looking for privacy when sharing your files or ideas." : "Tämä on oikea piiri, jos kaipaat yksityisyyttä jakaessasi tiedostoja tai ideoitasi.",
    ...
    "Everyone will be able to see and join your circle." : "Kaikki voivat nähdä ja liittyä piiriisi.",
