OC.L10N.register(
    ...
    "Files" : "Mafaili",
    "This feature is not available for personal teams" : "Kipengele hiki hakipatikani kwa timu za kibinafsi",
    ...
    "You are already a member of this team" : "Tayari wewe ni mwanachama wa timu hii",
    "You have been blocked from this team" : "Umezuiwa kutoka kwenye timu hii",
    "The account is already a member of this team" : "Akaunti tayari ni mwanachama wa timu hii",
    "The account has already been invited into this team" : "Akaunti tayari imealikwa katika timu hii",
    ...
    "%1$s shared %2$s with %3$s" : "%1$s imeshirikiwa %2$s na %3$s",
    "%1$s shared %2$s with \"%3$s\"" : "%1$s imeshirikiwa %2$s na \"%3$s\"",
    "Open %s" : "Fungua %s",
    ...
    "Federated Teams" : "Timu Zilizoshirikishwa",
    ...
    "Unable to update federated teams config" : "Imeshindwa kusasisha usanidi wa timu zilizoshirikishwa",
    "Invalid URL format. Please provide a valid URL." : "Umbizo la URL si sahihi. Tafadhali toa URL halali.",
    "Changed frontal cloud URL" : "Kubadilisha URL ya wingu la mbele",
    "Federation allows you to share teams with other trusted servers and make them discoverable across instances." : "Shirikisho hukuruhusu kushiriki timu na seva zingine zinazoaminika na kuzifanya ziweze kutambulika katika matukio yote.",
    "Enable federated teams" : "Washa timu zilizoshirikishwa",
    "Frontal URL" : "URL ya mbele",
    "https://…" : "https://…",
    ...
    "Next" : "Ijayo",
    "Back" : "Rudi",
    "Step {current} of {total}" : "Hatua {current} ya {total}",
    ...
    "Go back" : "Rudi nyuma",
    "Join" : "Jiunge",
    "Failed to load teams" : "Imeshindwa kupakia timu",
    "Join or create teams to see them here." : "Jiunge au uunde timu ili kuziona hapa.",
    "Loading…" : "Inapakia",
    "More teams" : "Timu zaidi",
