OC.L10N.register(
    "circles",
    {
    "Circles is using its own way to async heavy process." : "서클에서 자체적으로 무거운 프로세스를 비동기적으로 실행하고 있습니다.",
    ...
    "On events happening in a <strong>Circle</strong> you belong" : "소속된 <strong>서클</strong>에서 일어나는 이벤트",
    ...
    "The name of your circle must start with an alpha-numerical character" : "서클 이름은 알파벳이나 숫자로 시작해야 함",
    ...
    "Anyone can find and request an invitation to the circle; but only members will see who\\'s in it and get access to it\\'s shared items." : "누구나 서클을 검색하고 초대를 요청할 수 있으나, 서클 구성원만 구성원 목록을 볼 수 있으며 공유된 항목에 접근할 수 있습니다.",
    ...
    "Save settings" : "설정 저장",
    "Async Testing:" : "비동기 테스트:",
    "initiate async test in Circles" : "서클 비동기 테스트 실행",
    "reset test result" : "테스트 결과 초기화",
    "Test underway. Please wait." : "테스트 진행 중입니다. 잠시 기다려 주십시오.",
