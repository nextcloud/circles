OC.L10N.register(
    ...
    "Group" : "Группа",
    "Unable to load team folders" : "Не удалось загрузить папки группы",
    "Unable to load group quotas" : "Не удалось загрузить квоты группы",
    "Unable to load available team folders" : "Не удалось загрузить доступные папки группы",
    "Team folder added" : "Добавлена папка группы",
    ...
    "Actions" : "Действия",
    "Team folder name" : "Название папки команды",
    "Connect to OIDC provider" : "Подключиться к провайдеру OIDC",
    "Connect your account to an external OIDC provider to automatically sync your memberships with Nextcloud teams." : "Подключите свою учетную запись к внешнему провайдеру OIDC, чтобы автоматически синхронизировать свои членства в командах с командами Nextcloud.",
    "Reconnect" : "Переподключиться ",
    "Connect" : "Подключиться",
    "Members" : "Участники",
    "Please enter a team name" : "Пожалуйста, введите название команды",
    ...
    "Other" : "Другое",
    "Some members could not be added to the team" : "Некоторых участников не удалось добавить в команду",
    ...
    "You can always add or remove members later from the team page." : "Вы всегда можете добавить или удалить участников позже на странице команды.",
