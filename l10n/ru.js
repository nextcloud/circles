OC.L10N.register(
    "circles",
    {
    "Circles uses its own method to async heavy processes." : "Приложение «Круги» использует собственный способ асинхронного выполнения процессов, требовательных к ресурсам.",
    ...
    "initiate async test in Circles" : "запустить проверку параллельного выполнения",
    "reset test result" : "сбросить результат проверки",
    "Test underway. Please wait." : "Выполняется проверка, подождите.",
