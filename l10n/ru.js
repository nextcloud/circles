OC.L10N.register(
    ...
    "Select circles to filter by" : "Выберите круги, чтобы отфильтровать их по",
    "No circles found" : "Кругов не найдено",
    "Please select circles to filter by" : "Выберите круги, чтобы отфильтровать их по",
    ...
    "{author} cancelled {member}'s invitation to join {circle}" : "{autor} отменил(а) приглашение пользователя {member} присоединиться к кругу «{circle}»",
    ...
    "A secret circle is an hidden group that can only be seen by its members or by people knowing the exact name of the circle." : "Секретный круг — это скрытая группа, видимая только для входящих в неё участников, а также для тех, кому известно точное имя такого круга.",
