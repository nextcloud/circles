OC.L10N.register(
    ...
    "The member '{name}' was included in the circle" : "Участник «{name}» был добавлен в круг",
    "The member '{name}' could not be included in the circle" : "Участник «{name}» не может быть добавлен в круг",
    "Members of the group '{name}' were included in the circle" : "Участники группы  «{name}» были добавлены в круг",
    "Members of the group '{name}' could not be included in the circle" : "Участники группы «{name }» не могут быть добавлены в круг",
    ...
    "You requested an invitation into {circle}" : "Вы запросили приглашение в «{circle}»",
