OC.L10N.register(
    ...
    "Mail Contact" : "Отправить контакту email",
    ...
    "{member} joined {circle}" : "{member} присоединился(лась) к «{circle}»",
    ...
    "Your request to join {circle} has been dismissed by {author}" : "{author} отклонил Ваш запрос на присоединение к кругу «{circle}»",
    ...
    "The name of your circle must start with an alpha-numerical character" : "Название круга должно начинаться с буквы или цифры",
    ...
    "Level cannot be changed for that type of member" : "Невозможно изменить уровень участника такого типа",
    ...
    "User is already a member of this circle" : "Пользователь уже участник этого круга",
    "User is already invited into this circle" : "Пользователь уже приглашён в этот круг",
    ...
    "Joining a closed circle requires an invitation or a confirmation by a moderator." : "Скрытый круг требует принятия приглашения или одобрения запроса о вступлении модератором.",
    "Anyone can find the circle and request an invitation; but only members will see who's in it and get access to shared items." : "Любой пользователь сможет найти круг и запросить приглашение, но только его участки видят друг друга и получают доступ к его общим ресурсам.",
    ...
    "Anyone can see the circle, can join the circle and access the items shared to the circle." : "Любой пользователь сможет найти круг, присоединиться к нему и получить доступ к его общим ресурсам.",
