OC.L10N.register(
    ...
    "Link requested" : "Связь была запрошена",
    "Link up" : "Связь установена",
    "Personal Circle" : "Личный круг",
    "Hidden Circle" : "Скрытый круг",
    "Private Circle" : "Частный круг",
    "Public Circle" : "Общедоступный круг",
    ...
    "Accept the Link request" : "Принять запрос связи",
    "Reject the Link request" : "Отклонить запрос связи",
    ...
    "{author} has requested an invitation into {circle}" : "{author} запросил приглашение в {circle}",
    "You joined {circle}" : "Вы присоединились к  {circle}",
    "{member} has joined the circle {circle}" : "{member} присоеденился к  {circle}",
    ...
    "{member} has left {circle}" : "{member} покинул {circle}",
    ...
    "Link to a circle" : "Связать круги",
    ...
    "Linked" : "Связано",
    "Allow Federated Links" : "Разрешить федеративные связи",
    ...
    "Automatically Accept Link Request" : "Автоматически принимать запросы связи",
    "Warning: enabling this will automatically accept new Link requests from other circle." : "Внимание: при включении запросы связи из других кругов будут приниматься автоматически",
