OC.L10N.register(
    ...
    "This operation will add/invite every members from the group to the circle" : "Это операция добавит / пригласит каждого из участников группы в круг",
    ...
    "You were added as member to {circle} by {author}" : "{author} добавил вас участником в «{circle}»",
    "{member} was added as member to {circle} by {author}" : " {author} добавил участника {member} в «{circle}»",
    ...
    "Create a hidden circle" : "Создать скрытый круг",
