OC.L10N.register(
    ...
    "{author} added team {member} as member to {circle}" : "{author}がチーム{member}を{circle}のメンバーとして追加しました",
    ...
    "{author} removed {member} from {circle}" : "{author}が{circle}から{member}を削除しました",
    ...
    "{member} cancelled a request to join {circle}" : "{member} が {circle} への加入申請を取り消しました",
    ...
    "Teams" : "チーム",
    "On events happening in a <strong>team</strong> of which you are a member" : "あなたが所属する<strong>チーム</strong> で起きた出来事について",
    "Any important event in a <strong>team</strong> you are moderating" : "あなたがモデレーターを務める <strong>チーム</strong> の重要なイベント",
    "On global events happening in any <strong>team</strong>" : "どの<strong>チーム</strong>でも起きているグローバルな出来事について",
    "Single" : "シングル",
    "Personal" : "パーソナル",
    "System" : "システム",
    "Visible" : "表示する",
    ...
    "App" : "アプリ",
    "SCIM" : "SCIM",
    "Nextcloud Account" : "Nextcloud アカウント",
    ...
    "Teams App Initialization" : "Teamsアプリの初期設定",
    ...
    "Files" : "ファイル",
    "This feature is not available for personal teams" : "この機能は個人チームでは利用できません。",
    "The team is not federated" : "チームは統合されていません",
    "You cannot join this team" : "あなたはこのチームに参加できません",
    ...
    "This member is the owner of the team" : "このメンバーはチームのオーナーです",
    "Level cannot be changed for this type of member" : "このタイプのメンバーのレベルを変更することはできません",
    "You are already a member of this team" : "あなたはすでにこのチームのメンバーです。",
    "You have been blocked from this team" : "あなたはこのチームからブロックされています",
    "The account is already a member of this team" : "そのアカウントはすでにこのチームのメンバーです",
    "The account has already been invited into this team" : "そのアカウントはすでにこのチームに招待されています",
    "%s (Team owned by %s)" : "%s (%s が所有するサークル)",
    "You are now a member of the Team \"%2$s\"" : "あなたはチーム \"%2$s\" のメンバーになりました",
    "You have been invited by %1$s into the Team \"%2$s\"" : "あなたは%1$sからチーム \"%2$s\"に招待されています",
    "%1$s sent a request to be a member of the Team \"%2$s\"" : "%1$sがチーム\"%2$s\"のメンバー申請を送りました",
    "Accept" : "承諾",
    "Refuse" : "拒否する",
    "Leave the team" : "チームを離脱",
    ...
    "Unable to update federated teams config" : "統合されたチームの設定を更新できません",
    "Invalid URL format. Please provide a valid URL." : " 無効なURL形式です。有効なURLを入力してください。",
    "Changed frontal cloud URL" : " フロントのクラウドURLを変更",
    "Federation allows you to share teams with other trusted servers and make them discoverable across instances." : "フェデレーションでは、信頼できる他のサーバーとチームを共有し、インスタンス間で発見可能にできます。",
    "Enable federated teams" : "統合されたチームを有効にする",
    "Frontal URL" : "フロントURL",
    "https://…" : "https://…",
    "The public URL used by other instances to discover and connect to your teams." : "他のインスタンスがあなたのチームを検出して接続するために使用する公開URL。",
    "Unlimited" : "無制限",
    "Unable to load team folders" : "チームフォルダーを読み込めません",
    "Unable to load available team folders" : "利用可能なチームフォルダーを読み込めません",
    "Team folder added" : "チームフォルダーが追加されました",
    "Unable to add team folder" : "チームフォルダーを追加できません",
    "Delete team" : "チームを削除",
    "Are you sure you want to delete {team}? This cannot be undone." : "{team}を削除してもよろしいですか？この操作は元に戻せません。",
    "Cancel" : "キャンセル",
    "Team deleted" : "チームが削除されました",
    "Unable to delete the team" : "チームを削除できません",
    "Quota must be a non-negative number." : "クォータは負でない数値にする必要があります",
    "Changed team folder quota" : "チームフォルダーの上限容量を変更しました",
    "Unable to update team folder quota" : "チームフォルダーのクォータを更新できません",
    "Unable to update team folder quota for {team}" : "{team}のチームフォルダーのクォータを更新できませんでした",
    "Unable to update team folder config" : "チームフォルダーの設定を更新できません",
    "Changed default team folder quota" : "チームフォルダーのデフォルトの容量制限を変更しました",
    "Configure the default storage quota for team folders. Requires the Team Folders app to be installed and enabled." : "チームフォルダーのデフォルトのストレージクォータを設定します。この設定を行うには、「Team Folders」アプリがインストールされ、有効化されている必要があります。",
    "Default quota" : "デフォルトのクオータ",
    "Select default quota" : "デフォルトのクオータを選択",
    "Save" : "保存する",
    "Default storage quota applied to each auto-created team folder. Use 0 for unlimited storage." : "自動作成される各チームフォルダーに適用されるデフォルトのストレージクォータ。ストレージ容量を無制限にする場合は「0」を指定してください。",
    "Loading team folders…" : "チームフォルダーを読み込んでいます…",
    "Team folder" : "チームフォルダー",
    "Storage quota" : "ストレージのクォータ",
    "Actions" : "アクション",
    "No team folders found." : "チームフォルダーが見つかりません。",
    "Team actions" : "チームのアクション",
    "Add" : "追加",
    "Add a team folder" : "チームフォルダーを追加する",
    "This team folder can only be assigned to this team. It cannot be assigned to another team, and this action cannot be undone." : "このチームフォルダーは、このチームにのみ割り当てることができます。他のチームには割り当てることができず、この操作は元に戻すことができません。",
    "Create a new team folder" : "新しいチームフォルダーを作成する",
    "Team folder name" : "チームフォルダー名",
    "Use an existing team folder" : "既存のチームフォルダーを使用する",
    "Select a team folder" : "チームフォルダーを選択してください",
    "Connect to OIDC provider" : "OIDCプロバイダーに接続する",
    "Connect your account to an external OIDC provider to automatically sync your memberships with Nextcloud teams." : "アカウントを外部のOIDCプロバイダーに連携させると、メンバーシップがNextcloudチームと自動的に同期されます。",
    "Your account is connected." : "アカウントが連携されました。",
    "Reconnect" : "再接続",
    "Connect" : "接続",
    "Members" : "メンバー",
    "Please enter a team name" : "チーム名を入力してください",
    "The team name must be at least {min} characters long" : "チーム名は、少なくとも{min}文字以上である必要があります",
    "Add users" : "ユーザーを追加",
    "Add groups" : "グループを追加",
    "Add emails" : "メールを追加",
    "Add teams" : "チームを追加する",
    "Other" : "その他",
    "Some members could not be added to the team" : "一部のメンバーをチームに追加できませんでした",
    "Team created, but the initial members could not be added" : "チームは作成されましたが、初期メンバーを追加できませんでした",
    "Team \"{name}\" created" : "チーム\"{name}\"が作成されました",
    "Could not create the team" : "チームを作成できません",
    "Next" : "次へ",
    "Back" : "戻る",
    "Create team" : "チームを作成する",
    "Name your team" : "チームに名前を付ける",
    "Team name" : "チーム名",
    "e.g. Design" : "例：デザイン",
    "Advanced" : "高度な",
    "Create a team space" : "チームスペースを作成する",
    "A shared folder for this team. You can also add one later from the team page." : "このチーム用の共有フォルダーです。後でチームページから追加することもできます。",
    "Add initial members" : "初期メンバーを追加する",
    "Search people, groups, teams…" : "人、グループ、チームなどを検索…",
    "Cancel search" : "検索をキャンセルする",
    "Remove {name}" : "{name} を削除",
    "Search for people to add" : "追加するメンバーを検索",
    "You can always add or remove members later from the team page." : "チームページから、いつでもメンバーを追加したり削除したりすることができます。",
    "Could not load folder contents" : "フォルダーの内容を読み込めませんでした",
    "Team folder breadcrumbs" : "チームフォルダーのパンくずリスト",
    "Switch to list view" : "リスト表示へ切り替え",
    "Switch to grid view" : "グリッド表示へ切り替え",
    "Open folder in Files" : "ファイルアプリでフォルダーを開く",
    "Folder contents unavailable" : "フォルダーの内容にアクセスできません",
    "Empty folder" : "空のフォルダー",
    "This team folder is empty." : "このチームフォルダーは空です。",
    ...
    "Modified" : "更新日時",
    "Unknown date" : "不明な日付",
    "Switch team" : "チームを切り替える",
    "Show members" : "メンバーを表示する",
    "Copy team link" : "チームのリンクをコピー",
    "Leave team" : "チームを離脱",
    "Go to team" : "チームへ移動",
    "Search teams" : "チームを検索",
    "Home" : "ホーム",
    ...
    "Shared with the team" : "チームと共有済み",
    "Create team folder" : "チームフォルダーを作成する",
    "Create collective" : "コレクティブを作成",
    "New page" : "新規ページ",
    "New Deck board" : "新しいDeckボード",
    "Could not create the team folder" : "チームフォルダーを作成できませんでした",
    "Collective \"{name}\" created and linked to the team" : "\"{name}\"というコレクティブが作成され、チームにリンクされました",
    "Could not create the collective" : "コレクティブを作成できませんでした",
    "Deck board \"{name}\" created" : "デッキボード\"{name}\"が作成されました",
    "Could not create the Deck board" : "デッキボードを作成できませんでした",
    "A page name cannot contain \"/\"" : "ページ名には\"/\"を含めることはできません",
    "Page \"{name}\" created in the team folder" : "チームフォルダー内に\"{name}\"というページが作成されました",
    "A page named \"{name}\" already exists" : "\"{name}\"という名前のページはすでに存在します",
    "Could not create the page" : "ページを作成できません",
    "Page renamed to \"{name}\"" : "ページ名が\"{name}\"に変更されました",
    "Could not rename the page" : "ページ名を変更できません",
    "Delete page" : "ページの削除",
    "Are you sure you want to delete the page \"{name}\"? It can be restored from the trash bin." : "\"{name}\"というページを削除してもよろしいですか？ ゴミ箱から復元することができます。",
    "Page \"{name}\" deleted" : "ページ\"{name}\"が削除されました",
    "Could not delete the page" : "ページを削除できません",
    "Could not save the navigation order" : "ナビゲーションの順序を保存できませんでした",
    "Team sections" : "チーム別セクション",
    "Team resources" : "チームのリソース",
    "Create team resources" : "チームのリソースを作成",
    "More coming soon" : "続報は近日公開予定",
    ...
    "Error picking team picture" : "チーム写真の選択にエラーが発生しました",
    "Error cropping avatar picture" : "アバター画像のトリミングに失敗しました",
    "name" : "名前",
    "description" : "説明",
    "picture" : "画像",
    "An error happened while saving {fields}" : "{fields}の保存中にエラーが発生しました",
    "Team details saved" : "チームの詳細が保存されました",
    "Team details" : "チームの詳細",
    "Team picture" : "チーム画像",
    "Upload team picture" : "チーム写真をアップロードする",
    ...
    "Edit team picture" : "チーム写真を編集する",
    "Apply" : "適用",
    "An error happened during the config change" : "構成の変更中にエラーが発生しました",
    "Confirm enabling federation" : "フェデレーションの有効化を確認する",
    "Enabling this will prevent {circle} from being a member of other teams.\nAre you sure?" : "これを有効にすると、{circle}は他のチームのメンバーになれなくなります。本当に実行しますか？",
    "Enable federation" : "フェデレーションを有効にする",
    "Create link" : "リンクを作成する",
    "Copy link" : "リンクをコピー",
    "Reset link" : "リンクをリセット",
    "This action will make it impossible to join the team using the current link. Do we really want to change the link?" : "この操作を行うと、現在のリンクを使ってチームに参加できなくなります。本当にリンクを変更してもよろしいですか？",
    "Reject link" : "リンクを拒否する",
    "This action will make it impossible to join the team using the current link. Do we really want to delete the link?" : "この操作を行うと、現在のリンクからチームに参加できなくなります。本当にリンクを削除してもよろしいですか？",
    ...
    "Search among current members" : "現在のメンバーの検索",
    "Role" : "ロール",
    "Filter by role" : "役割によるフィルター",
    "Loading members list …" : "メンバーリストを読み込んでいます…",
    "No members found matching your search" : "検索条件に一致するメンバーは見つかりませんでした",
    "You currently have no access to the member list" : "メンバーリストへのアクセス権がありません",
    "Add to {team}" : "{team} に追加",
    "Invite members to {team}" : "メンバーに{team} に参加するように招待します",
    "My teams" : "私のチーム",
    "and everything shared with them across Nextcloud." : "そして、Nextcloudを通じて彼らと共有されたすべてのもの。",
    "Could not load teams" : "チームを読み込めませんでした",
    "Something went wrong while loading your teams." : "チームの読み込み中に問題が発生しました。",
    "Try again" : "もう一度試してください",
    "No teams yet" : "まだチームはありません",
    "Create your first team to start collaborating." : "最初のチームを作成して、コラボレーションを始めましょう。",
    "Create your first team" : "最初のチームを作成する",
    "No teams found" : "チームは見つかりませんでした",
    "Try a different search." : "別の検索を試してみてください。",
    "You have joined the team {circleName}." : "{circleName}チームに参加しました。",
    "Loading" : "読み込み中",
    "Invitation to the team" : "チームへの招待",
    "You are already a member of the team <b>{circleName}</b>." : "あなたはすでに<b>{circleName}</b>チームのメンバーです。",
    "Go to team page" : "チームページへ",
    "You already requested to join the team <b>{circleName}</b>." : "すでにチーム <b>{circleName} </b>への参加をリクエスト済みです。",
    "Go back" : "戻る",
    "Do you want to join the team <b>{circleName}</b>?" : "<b>{circleName}</b>チームに参加してみませんか？",
    "Join" : "参加",
    "Invalid invitation link" : "無効な招待リンク",
    "This invitation link is not valid or has expired." : "この招待リンクは無効か、有効期限が切れています。",
    "The Text app is required to show team pages" : "チームページを表示するには、「Text」アプリが必要です",
    "This page no longer exists" : "このページは存在しません",
    "Could not open the page" : "ページを開くことができませんでした",
    "This team does not have a team folder yet. Ask your administrator to enable the Team Folders app." : "このチームにはまだチームフォルダーがありません。管理者に「Team Folders」アプリの有効化を依頼してください。",
    "This team does not have a team folder yet. Create one to share files with the whole team." : "このチームにはまだチームフォルダーがありません。チーム全体でファイルを共有するために、フォルダーを作成してください。",
    "This team does not have a team folder yet. Ask a team owner to create one." : "このチームにはまだチームフォルダがありません。チームオーナーに作成を依頼してください。",
    "Team folder unavailable" : "チームフォルダーが利用できません",
    "Could not load the team folder. Please try again later." : "チームフォルダーを読み込めませんでした。後ほどもう一度お試しください。",
    "No team folder yet" : "チームフォルダーはまだありません",
    "Group folders" : "グループフォルダー",
    "You are not a member of {circle}" : "あなたはサークル{circle}のメンバーではありません",
    "Could not load the team" : "チームを読み込めませんでした",
    "Unable to join the team" : "チームに参加できません",
    "Team not found" : "チームが見つかりません",
    "This team may have been removed." : "このチームは削除された可能性があります。",
    "Your request to join this team is pending approval" : "このチームへの参加リクエストは承認待ちです",
    "Request to join" : "参加リクエスト",
    "Failed to load teams" : "チームの読込に失敗しました",
    "Join or create teams to see them here." : "チームに参加するか作成してここで確認してください。",
    "Loading…" : "読み込み中…",
    "More teams" : "その他のチーム",
    "Link copied to the clipboard" : "リンクがクリップボードにコピーされました",
    "Could not copy link to the clipboard" : "クリップボードにリンクをコピーできませんでした",
    "Are you sure you want to leave {team}?" : "{team}を退会してもよろしいですか？",
    "Could not leave the team" : "チームを離れることができませんでした",
    "Could not delete the team" : "チームを削除できませんでした",
    ...
    "Create your own teams for sharing. Add Nextcloud users, contacts, or anyone via email." : "共有用のチームを作成しましょう。Nextcloudのユーザーや連絡先、あるいはメール経由で誰でも追加できます。",
    "User" : "ユーザー",
    "Group" : "グループ",
    "Email" : "メール",
    "Invites" : "招待",
    ...
    "contacts" : "連絡先",
    "Contacts" : "連絡先",
    "An error has occurred in team(s). Check the log for more details." : "チームでエラーが発生しました。詳細についてはログを確認してください。",
