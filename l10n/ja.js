OC.L10N.register(
    ...
    "You added circle {member} as member to {circle}" : "あなたは {circle} にサークル {member} をメンバーとして追加しました",
    "{author} added circle {member} has been added as member to {circle}" : "{author} がサークル {member} のメンバーとして {circle} に追加されました",
    "You removed {member} leave {circle}" : "あなたは {member} を {circle} から外しました",
    ...
    "Circle not found " : "サークルが見つかりません",
    "This account is already a member of the circle" : "このアカウントはすでにサークルのメンバーです",
    ...
    "%s (Circle owned by %s)" : "%s (%sが所有するサークル)",
