OC.L10N.register(
    ...
    {
    "Teams" : "الفِرَق",
    "Teams' files" : "ملفات الفِرَق",
    "Select team to filter by" : "حدِّد فريقاً للفلترة بحسبه",
    "No teams found" : "لا يوجد أي فريق",
    "Please select teams to filter by" : "رجاءً، حَدِّد فِرَقاً للفلترة بحسبها",
    "No files found for the selected teams" : "لا توجد أي ملفات للفِرَق المحددة",
