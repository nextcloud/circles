OC.L10N.register(
    ...
    "You added team {member} as member to {circle}" : "Du lade till team {member} som medlem till {circle}",
    ...
    "Open" : "Öppen",
    "Invite" : "Bjud in",
    "Join request" : "Anslutningsförfrågan",
    "Friends" : "Vänner",
    ...
    "%s (Team owned by %s)" : "%s (Team ägs av %s)",
    "You are now a member of the Team \"%2$s\"" : "Du är nu medlem i Team \"%2$s\"",
    "You have been invited by %1$s into the Team \"%2$s\"" : "Du har blivit inbjuden av %1$s till Team \"%2$s\"",
    "%1$s sent a request to be a member of the Team \"%2$s\"" : "%1$s skickade en förfrågan att bli medlem i Team \"%2$s\"",
    "Accept" : "Acceptera",
    "Refuse" : "Neka",
    "Leave the team" : "Lämna team",
    ...
    "Changed frontal cloud URL" : "Ändrade den publika moln URL:en",
    ...
    "Frontal URL" : "Publik URL",
    "https://…" : "https://…",
    "The public URL used by other instances to discover and connect to your teams." : "Den offentliga URL som används av andra instanser för att upptäcka och ansluta till dina team.",
