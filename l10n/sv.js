OC.L10N.register(
    ...
    "The request to link {remote} with {circle} has been canceled remotely" : "Begäran att länka {remote} med {circle} har avbrutits av fjärran part",
    ...
    "{author} canceled the request to link {circle} with {remote}" : "{author} avbröt begäraan att länka {circle} med {remote}",
    ...
    "The link between {circle} and {remote} has been shutdown remotely" : "Länken mellan {circle} och {remote} har blivit avstängt av fjärran part",
    ...
    "You need a specify a type of circle" : "Du behöver specifiera en cirkeltyp",
    ...
    "The remote host is down or the Circles app is not installed on it" : "Fjärrvärden är nere eller saknar cirkelappen",
    "Federated circles are not allowed on the remote Nextcloud" : "Federerade cirklar är inte tillåtet på den fjärran Nextcloud-instansen",
    "The remote circle does not accept federated links" : "Fjärran cirkel accepterar inte federerade länkar",
    ...
    "The requested remote circle does not exist" : "Den begärda fjärrcirkeln finns inte",
    ...
    "Email format is not valid" : "Email-format är inte giltigt",
    ...
    "Create a public circle" : "Skapa en publik cirkel",
    ...
    "A public circle is an open group visible to anyone willing to join." : "En publik cirkel är en öppen grupp synlig för vem som helst som vill gå med.",
    ...
    "Public circles" : "Publika cirklar",
