OC.L10N.register(
    ...
    "You added circle {member} as member to {circle}" : "Ви додали {member} до {circle}",
    "{author} added circle {member} has been added as member to {circle}" : "{author} додав(-ла) {member}, який(-а) вже входить до {circle}",
    "You removed {member} leave {circle}" : "Ви вилучили {member} із {circle}",
