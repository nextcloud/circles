OC.L10N.register(
    ...
    "{member} declined an invitation to join {circle}" : "{member} відхилив(-ла) запрошення приєднатися до {circle}",
    ...
    "{author} cancelled {member}'s invitation to join {circle}" : "{author} скасував(-ла) запрошення {member} приєднатися до {circle}",
    ...
    "{member} has been invited to join {circle} by {author}" : "{member} отримав(-ла) запрошення приєднатися до {circle} від {author}",
    ...
    "{member} sent a request to join {circle}" : "{member} надіслав(-ла) запит на приєднання до {circle}",
    "You are the new owner of {circle}" : "Ви є новим власником {circle}",
    ...
    "Unable to update federated teams config" : "Не вдалося оновити налаштування команд об'єднаних хмар",
    "Invalid URL format. Please provide a valid URL." : "Недійсний формат URL. Надайте посилання у правильному форматі.",
    "Changed frontal cloud URL" : "Змінено фронтальне посилання на хмару",
    "Federation allows you to share teams with other trusted servers and make them discoverable across instances." : "Об'єднані хмари дозволяють надавати у спільний доступ ресурси команд іншим довіреним хмарним сервісам, робити так, щоб їх можна було виявити користувачами інших примірників хмар Nextcloud.",
    "Enable federated teams" : "Увімкнути команди об'єднаних хмар",
    "Frontal URL" : "Посилання спільного доступу до хмари",
    "https://…" : "https://…",
    "The public URL used by other instances to discover and connect to your teams." : "Публічне посилання, яке використовується іншими примірниками для пошуку та з'єднання з вашими командами.",
    ...
    "Next" : "Далі",
    "Back" : "Назад",
    "Step {current} of {total}" : "Крок {current} від {total}",
    ...
    "Create team folder" : "Створити каталог команди",
    "Add" : "Додати",
    "Apply" : "Застосувати",
    ...
    "Team space" : "Робоча область команди",
