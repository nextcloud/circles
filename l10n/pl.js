OC.L10N.register(
    "circles",
    {
    "Are you sure you want to transfer your Owner rights ?" : "Jesteś pewny, że chcesz przekazać swoje uprawnienia właściciela?",
    ...
    "Remove this Link" : "Usuń Link",
    "Cancel the Link request" : "Anuluj żądanie Linka",
    "Accept the Link request" : "Akceptuj żądanie Linka",
    "Cannot join this circle" : "Nie można dołączyć do tego kręgu",
    "no error message" : "Brak wiadomości błędu",
    "You have successfully joined this circle" : "Dołączyłeś do tego kręgu",
    "You have requested to join this circle" : "Wysłałeś prośbę o dołączenie do tego kręgu",
    "You have successfully left this circle" : "Opuściłeś ten krąg",
    "Cannot leave this circle" : "Nie można opuścić tego kręgu",
    "You have successfully deleted this circle" : "Krąg został pomyślnie usunięty",
    ...
    "This operation will add/invite every members from the group to the circle" : "Ta operacja doda/zaprosi wszystkich członków grupy do tego kręgu",
    "Member '{name}' successfully added to the circle" : "Użytkownik '{name}' został dodany do kręgu",
    "Member '{name}' could not be added to the circle" : "Nie udało się dodać '{name}' do kręgu",
    "Members from group '{name}' could not be added to the circle" : "Użytkownicy z grupy '{name}' nie mogli zostać dodani do kręgu",
    "Member '{name}' successfully removed from the circle" : "Użytkownik '{name}' został usunięty z kręgu",
    "Member '{name}' could not be removed from the circle" : "Nie udało się usunąć użytkownika '{name}' z kręgu",
    "Member '{name}' updated" : "Użytkownik '{name}' został zaktualizowany",
    "Member '{name}' could not be updated" : "Użytkownik '{name}' nie może zostać zaktualizowany",
    ...
    "You were added as member to {circle} by {author}" : "Zostałeś dodany do członków {circle} przez {author}",
    "{member} was added as member to {circle} by {author}" : "{member} został dodany do członków {circle} przez {author}",
    ...
    "You were removed from {circle} by {author}" : "Zostałeś usunięty z {circle} przez {author}",
    "{member} was removed from {circle} by {author}" : "{member} został usunięty z {circle} przez {author}",
    "You invited {member} into {circle}" : "Zaprosiłeś {member} do {circle}",
    "You have been invited into {circle} by {author}" : "Zostałeś zaproszony do {circle} przez {author}",
    "{member} have been invited into {circle} by {author}" : "{member} został zaproszony do {circle} przez {author}",
    ...
    "You closed the link between {circle} and {link}" : "Zamknąłeś połączenie pomiędzy {circle} i {link}",
    "{author} closed the link between {circle} and {link}" : "{author} zamknął połączenie pomiędzy {circle} i {link}",
    ...
    "Federated circles are not allowed on this Nextcloud" : "Stowarzyszone kręgi nie są dozwolone w tym Nextcloud",
    ...
    "Federated Link not found" : "Link zjednoczony nie został znaleziony",
    ...
    "This option is not available for personal circles" : "Ta opcja nie jest dostępna dla kręgów osobistych",
    ...
    "Not enough privileges" : "Niewystarczające uprawnienia",
    "This member is not the owner of the circle" : "Ten członek nie jest właścicielem kręgu",
    "This member is not admin of the circle" : "Ten użytkownik nie jest administratorem tego kręgu",
    ...
    "The remote circle does not accept Federated Links" : "Zdalny krąg nie akceptuje Linków Stowarzyszonych",
    "It seems that you are trying to link a circle to itself" : "Wygląda na to, że prubujesz połączyć krąg z nim samym",
    ...
    "Create a hidden circle" : "Utwórz ukryty krąg",
    ...
    "This is the right option if you want to do recurrent sharing with the same group." : "Jest to odpowiednia opcja, jeśli chcesz powtarzać współużytkowanie z tą samą grupą.",
    ...
    "Users won't be able to find this circle using the Nextcloud search engine." : "Użytkownicy nie będą w stanie znaleźć tego kręgu poprzez wyszukiwarkę Nextcloud.",
    "A private circle requires invitation or confirmation by an admin." : "Prywatny krąg wymaga zaproszenia lub potwierdzenia przez administratora.",
    "This is the right circle if you are looking for privacy when sharing your files or ideas." : "Ten krąg jest odpowiedni jeśli poszukujesz prywatności podczas udostępniania swoich plików i pomysłów.",
    ...
    "Everyone will be able to see and join your circle." : "Każdy będzie mógł widzieć i dołączyć do tego kręgu.",
    ...
    "Automatically Accept Link Request" : "Automatycznie akceptuj prośby o połączenie",
