OC.L10N.register(
    "circles",
    {
    "Circles is using its own way to async heavy process." : "Kręgi używają własnego sposobu na synchronizację mocno obciążonego procesu.",
    ...
    "The name of your circle must start with an alpha-numerical character" : "Nazwa kręgu musi zaczynać się znakiem alfa-numerycznym",
    ...
    "Level cannot be changed for that type of member" : "Nie można zmienić poziomu dla tego typu członka",
    ...
    "User is already a member of this circle" : "Użytkownik jest już członkiem tego kręgu",
    "User is already invited into this circle" : "Użytkownik został już zaproszony do tego kręgu",
    ...
    "Joining a closed circle requires an invitation or a confirmation by a moderator." : "Przyłączenie do zamkniętego kręgu wymaga zaproszenia lub potwierdzenia przez moderatora.",
    "Anyone can find the circle and request an invitation; but only members will see who's in it and get access to shared items." : "Każdy może znaleźć krąg i poprosić  o zaproszenie; ale tylko członkowie będą widzieć kto jest w kręgu i mieć dostęp do udostępnionych danych.",
    ...
    "Anyone can see the circle, can join the circle and access the items shared to the circle." : "Każcy może widzieć krąg, może dołączyć do kręgu i mieć dostęp do danych udostępnionych w kręgu.",
    ...
    "Turns the circle as Federated and enable sharing between Federated Circles" : "Przełącza krąg jako Zjednoczony i włącza udostępnianie między kręgami Zjednoczonymi/Stowarzyszonymi.",
    "Automatically Accept Link Request" : "Automatycznie akceptuj prośby o połączenie",
    "Warning: enabling this will automatically accept new link requests from other circle." : "Uwaga: włączenie tego spowoduje automatyczną akceptację prośby o podłączenie z innego kręgu",
    "Save settings" : "Zapisz ustawienia",
    "Async Testing:" : "Testowanie synchronizacji: ",
    "initiate test of Circles Async" : "inicjuj test Synchronizacji Kręgów",
    "reset test result" : "zresetuj wyniki testu",
    "Test is currently running. Please wait." : "Testowanie w trakcie. Proszę czekać.",
    "Allow Group Linking:" : "Zezwól linkowanie grup: ",
