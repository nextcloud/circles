OC.L10N.register(
    ...
    "You added circle {member} as member to {circle}" : "Dodałeś zespół {member} jako członka do {circle}",
    "{author} added circle {member} has been added as member to {circle}" : "{author} dodał zespół {member} jako członka do {circle}",
    "You removed {member} leave {circle}" : "Usunąłeś {member}, opuścił {circle}",
    ...
    "Circle not found " : "Krąg nie został znaleziony ",
    "This account is already a member of the circle" : "To konto jest już członkiem tego kręgu",
