OC.L10N.register(
    ...
    "Reject the Link request" : "Odrzuć żądanie Linka",
    ...
    "The member '{name}' was included in the circle" : "Członek '{name}' został włączony do kręgu",
    "The member '{name}' could not be included in the circle" : "Członek '{name}' nie mógł zostać włączony do kręgu",
    "Members of the group '{name}' were included in the circle" : "Członkowie grupy '{name}' zostali włączeni do kręgu",
    "Members of the group '{name}' could not be included in the circle" : "Członkowie grupy '{name}' nie mogli zostać włączeni do kręgu",
    ...
    "You sent a request to link {circle} with {link}" : "Wysłałeś prośbę o połączenie {circle} z {link}",
    "{author} sent a request to link {circle} with {link}" : "{author} wysłał prośbę o połączenie {circle} z {link}",
    "{link} requested a link with {circle}" : "{link} wysłał prośbę o połączenie z {circle}",
