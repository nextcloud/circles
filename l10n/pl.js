OC.L10N.register(
    ...
    "{author} has requested an invitation into {circle}" : "{author} wysłał prośbę o dołączenie do {circle}",
    "You joined {circle}" : "Dołączyłeś do {circle}",
    "{member} has joined the circle {circle}" : "{member} dołączył do kręgu {circle}",
    ...
    "{member} has left {circle}" : "{member} opuścił {circle}",
    ...
    "You shared a mood with %1$s" : "Udostępniłeś swój nastrój %1$s",
    "You shared a mood with {circles}" : "Udostępniłeś swój nastrój z {circles}",
    "%1$s shared a mood with %2$s" : "%1$s udostępnił swój nastrój %2$s",
    "{author} shared a mood with {circles}" : "{author} udostępnił swój nastrój {circles}",
