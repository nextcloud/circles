OC.L10N.register(
    ...
    "Select circles to filter by" : "Wybierz kręgi do filtrowania",
    "No circles found" : "Nie znaleziono żadnych kręgów",
    "Please select circles to filter by" : "Należy wybrać kręgi do filtrowania",
    ...
    "On events happening in a <strong>Circle</strong> of which you are a member" : "Na wydarzenia w <strong>Kręgu</strong>, którego jesteś członkiem",
    "Any important event in a <strong>Circle</strong> you are moderating" : "Wszelkie ważne wydarzenie w <strong>Kręgu</strong>, które moderujesz",
    "On global events happening in any <strong>Circle</strong>" : "Na wydarzenia globalne w dowolnym <strong>Kręgu</strong>",
    ...
    "Open »%s«" : "Otwórz »%s«",
    "%1$s shared multiple files with you.\nYou should have already received a separate mail with a link to access them.\n" : "%1$sudostępnił Ci wiele plików.\nPowinieneś otrzymać osobną wiadomość e-mail z linkiem, aby uzyskać do nich dostęp.\n",
    "%1$s shared multiple files with you. You should have already received a separate mail with a link to access them." : "%1$s udostępnił Ci wiele plików. Powinieneś otrzymać osobną wiadomość e-mail z linkiem, aby uzyskać do nich dostęp.",
    ...
    "%s shared multiple files with '%s'." : "%s udostępnił wiele plików dla '%s'.",
    "%s shared multiple files with you." : "%s udostępnił Ci wiele plików.",
    ...
    "On events happening in a <strong>Circle</strong> you belong" : "Na wydarzenia w <strong>Kręgu</strong>, do którego należysz",
