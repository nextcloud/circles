OC.L10N.register(
    ...
    "You made {member} join {circle}" : "Учинили сте да се {member} придружи кругу {circle}",
    "{author} made {member} join {circle}" : "{author} је учинио да се {member} придружи кругу {circle}",
    "You added team {member} as member to {circle}" : "Додали сте тим {member} као члана у {circle}",
    "{author} added team {member} as member to {circle}" : "{author} је додао тим {member} као члана {circle}",
    "You made {member} leave {circle}" : "Учинили сте да {member} напусти круг {circle}",
    "{author} made {member} leave {circle}" : "{author} је учинио да {member} напусти круг {circle}",
    "You removed {member} from {circle}" : "Уклонили сте корисника {member} из круга {circle}",
    "{author} removed {member} from {circle}" : "{author} је уклонио {member} из {circle}",
    ...
    "{member} cancelled a request to join {circle}" : "{member} је отказао захтев да се придружи кругу {circle}",
    ...
    "Open" : "Отвори",
    "Invite" : "Позив",
    "Join request" : "Захтев за приступање",
    "Friends" : "Пријатељи",
    ...
    "Local" : "Локално",
    "Root" : "Корен",
    "Team invite" : "Позивница тима",
    "Federated" : "Здружено",
    "Mount point" : "Тачка монтирања",
    "Nextcloud Account" : "Nextcloud налог",
    ...
    "%1$s shared »%2$s« with you. You should have already received a separate email with a link to access it." : "%1$s је са вама поделио »%2$s«. Требало би да сте већ примили посебан и-мејл са линком за приступ.",
    ...
    "%1$s shared multiple files with you. You should have already received a separate email with a link to access them." : "%1$s је са вама поделио више фајлова. Требало би да сте већ примили посебан и-мејл са линком за приступ.",
    ...
    "This member is the owner of the team" : "Овај члан је власник тима",
    ...
    "The account is already a member of this circle" : "Овај налог је већ члан овог круга",
    "The account has already been invited into this circle" : "Налог је већ раније позван у овај круг",
    "%s (Team owned by %s)" : "%s (Власник тима је %s)",
    "You are now a member of the Team \"%2$s\"" : "Сада сте члан тима „%2$s“",
    "You have been invited by %1$s into the Team \"%2$s\"" : "%1$s Вас је позвао/ла у Тим „%2$s“",
    "%1$s sent a request to be a member of the Team \"%2$s\"" : "%1$s је послао захтев да буде члан Тима „%2$s“",
    "Accept" : "Прихвати",
    "Refuse" : "Одбиј",
    ...
    "Password to access content" : "Лозинка за приступ садржају",
    ...
    "You removed {member} leave {circle}" : "Уклонили сте корисника {member} из круга {circle}",
    ...
    "%s (Circle owned by %s)" : "%s (Власник круга је %s)",
    ...
    "now" : "сада",
    "This account does not exist" : "Овај налог не постоји",
    ...
    "{author} added team {member} has been added as member to {circle}" : "{author} је додао тим {member} као члана {circle}"
},
