OC.L10N.register(
    "circles",
    {
    "Circles uses its own method to async heavy processes." : "Кругови користе сопствени метод да асинхроно извршавају веће процесе.",
    ...
    "initiate async test in Circles" : "Започни асинхрони тест Кругова",
    "reset test result" : "ресетуј резултате теста",
    "Test underway. Please wait." : "Тест тренутно ради. Сачекајте.",
