OC.L10N.register(
    "circles",
    {
    "Circles uses its own method to async heavy processes." : "Circles uses its own method to async heavy processes.",
    ...
    "initiate async test in Circles" : "initiate async test in Circles",
    "reset test result" : "reset test result",
    "Test underway. Please wait." : "Test underway. Please wait.",
