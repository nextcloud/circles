OC.L10N.register(
    ...
    "Unlimited" : "無限制",
    "Unable to update team space config" : "無法更新團隊空間設定",
    "Changed default team space quota" : "已更改預設團隊空間配額",
    "Quota must be a non-negative number." : "配額必須為非負數。",
    "Automatically create a shared team space when a new team is created. Requires the Team Folders app to be installed and enabled." : "建立新團隊時自動建立共享團隊空間。必須已安裝並啟用「團隊資料夾」應用程式。",
    "Automatically create a team space" : "自動建立團隊空間",
    "Default quota" : "默認儲存容量限制",
    "Select default quota" : "選擇預設容量限制",
    "Save" : "儲存",
    "Default storage quota applied to each auto-created team space. Use 0 for unlimited storage." : "套用於每個自動建立團隊空間的預設儲存空間配額。設為 0 即表示無限制。",
    ...
    "Optional, you can also add members later" : "選填，你亦可稍後新增成員",
    ...
    "Team space breadcrumbs" : "團隊空間路徑導覽",
    ...
    "Empty folder" : "空白資料夾",
    "This team space is empty." : "此團隊空間是空的。",
    ...
    "New folder" : "新資料夾",
    "Folder name" : "資料夾名稱",
    "This will create a regular folder shared with the team." : "這會建立一個與團隊共享的一般資料夾。",
    "Talk conversation" : "Talk 對話",
    "New Talk conversation" : "新增 Talk 對話",
    "Conversation name" : "對話名稱",
    "Collective" : "Collective",
    "Calendar" : "日曆",
    "New calendar" : "新日曆",
    "Calendar name" : "日曆名稱",
    "Could not load team space" : "無法載入團隊空間",
    "Could not create the team space" : "無法建立團隊空間",
    "Unknown resource type" : "未知的資源類型",
    "Team calendar \"{resourceName}\" created and shared with team" : "已建立團隊日曆「{resourceName}」並與團隊分享",
    "{resourceType} \"{resourceName}\" created and shared with team" : "已建立{resourceType}「{resourceName}」並與團隊分享",
    "A calendar named \"{name}\" already exists. Please choose a different name." : "名為「{name}」的日曆已存在。請選擇其他名稱。",
    "Failed to create {resourceType}: {error}" : "無法建立{resourceType}：{error}",
    ...
    "Your teams and everything shared with them across Nextcloud." : "你的團隊，以及在 Nextcloud 中與這些團隊分享的所有內容。",
    ...
    "Team space unavailable" : "無法使用團隊空間",
    "Could not load the team space. Please try again later." : "無法載入團隊空間。請稍後再試。",
    ...
    "Join team" : "加入團隊",
    "You are about to leave {circle}.\nAre you sure?" : "你即將離開 {circle}。\n確定要繼續嗎？",
    "Please confirm team leave" : "請確認離開團隊",
    "Could not leave the team {displayName}" : "無法離開團隊 {displayName}",
    "Unable to join the team" : "無法加入團隊",
    "You are about to delete {circle}.\nAre you sure?" : "你即將刪除 {circle}。\n確定要繼續嗎？",
    "Please confirm team deletion" : "請確認刪除團隊",
