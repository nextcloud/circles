OC.L10N.register(
    "circles",
    {
    "Are you sure you want to transfer your Owner rights ?" : "Êtes-vous sûr de vouloir transférer vos droits de propriétaire ?",
    ...
    "You have successfully joined this circle" : "Vous avez rejoint ce cercle avec succès",
    "You have requested to join this circle" : "Vous avez demandé à rejoindre ce cercle",
    "You have successfully left this circle" : "Vous avez quitté ce cercle avec succès",
    "Cannot leave this circle" : "Impossible de quitter ce cercle",
    "You have successfully deleted this circle" : "Vous avez supprimé ce cercle avec succès",
    ...
    "Member '{name}' successfully added to the circle" : "Membre '{name}' ajouté au cercle avec succès",
    "Member '{name}' could not be added to the circle" : "Membre '{name}' n'a pu être ajouté au cercle",
    "Members from group '{name}' successfully added to the circle" : "Les membres du groupe '{name}' ont été ajoutés au cercle avec succès",
    "Members from group '{name}' could not be added to the circle" : "Les membres du groupe '{name}' n'ont pas pu être ajoutés au cercle",
    "Member '{name}' successfully removed from the circle" : "Membre '{name}' supprimé du cercle avec succès",
    ...
    "On event in a <strong>Circle</strong> you are a member, or a potential member" : "Dès qu'un évènement survent dans un <strong>Cercle</strong> dont vous êtes membre, ou membre potentiel",
    ...
    "Create an hidden circle" : "Créer un cercle caché",
