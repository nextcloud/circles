OC.L10N.register(
    ...
    "{author} has requested an invitation into {circle}" : "{author} a demandé une invitation pour {circle}",
    "You joined {circle}" : "Vous avez rejoint {circle}",
    "{member} has joined the circle {circle}" : "{member} a rejoint le cercle {circle}",
    ...
    "{member} has left {circle}" : "{member} a quitté {circle}",
