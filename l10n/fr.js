OC.L10N.register(
    ...
    "You rejected the invitation to join {circle}" : "Vous avez rejeté l'invitation à rejoindre {cercle}",
    "{member} rejected the invitation to join {circle}" : "{membre} a rejeté l'invitation à rejoindre {cercle}",
