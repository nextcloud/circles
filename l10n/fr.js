OC.L10N.register(
    "circles",
    {
    "Circles uses its own method to async heavy processes." : "Circles utilise une méthode qui lui est propre pour traiter les tâches lourdes de manière asynchrone.",
    ...
    "Anyone can find and request an invitation to the circle; but only members will see who\\'s in it and get access to it\\'s shared items." : "Tout le monde peut trouver le cercle et faire une demande d'invitation; mais seuls les membres verront la liste des membres et auront accès aux éléments partagés.",
    ...
    "initiate async test in Circles" : "Démarrer un test async dans les cercles",
    "reset test result" : "Réinitialiser les résultats du test",
    "Test underway. Please wait." : "Test en cours. Veuillez patienter.",
