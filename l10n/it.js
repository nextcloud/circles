OC.L10N.register(
    "circles",
    {
    "Circles is using its own way to async heavy process." : "Cerchie sta utilizzando la sua modalità per rendere asincrono il processo pesante.",
    ...
    "Select circles to filter by" : "Selezionamle cerchie per filtrare",
    ...
    "On events happening in a <strong>Circle</strong> you belong" : "Per gli eventi che si verificato in una <strong>cerchia</strong> alla quale appartieni",
    ...
    "The name of your circle must start with an alpha-numerical character" : "Il nome della tua cerchia deve iniziare con un carattere alfanumerico",
    ...
    "Level cannot be changed for that type of member" : "Il livello non può essere modificato per questo tipo di membro",
    ...
    "User is already a member of this circle" : "L'utente è già membro di questa cerchia",
    "User is already invited into this circle" : "L'utente è già invitato in questa cerchia",
    ...
    "Joining a closed circle requires an invitation or a confirmation by a moderator." : "La partecipazione a una cerchia chiusa richiede un invito o una conferma da un moderatore.",
    "Anyone can find the circle and request an invitation; but only members will see who's in it and get access to shared items." : "Chiunque può trovare la cerchia e richiedere un invito, ma solo i membri vedranno chi vi partecipa e accedere agli elementi condivisi.",
    ...
    "Anyone can see the circle, can join the circle and access the items shared to the circle." : "Chiunque può vedere la cerchia, può unirsi alla cerchia e accedere agli elementi condivisi nella cerchia.",
    ...
    "Turns the circle as Federated and enable sharing between Federated Circles" : "Trasforma la cerchia in federata e abilita la condivisione tra le cerchie federate",
    "Automatically Accept Link Request" : "Accetta automaticamente richieste di collegamento",
    "Warning: enabling this will automatically accept new link requests from other circle." : "Avviso: l'abilitazione di questa opzione accetterà automaticamente nuove richieste di collegamento da altre cerchie.",
    "Save settings" : "Salva impostazioni",
    "Async Testing:" : "Test asincrono:",
    "initiate test of Circles Async" : "inizia il test di Cerchie asincrono",
    "reset test result" : "ripristina i risultati del test",
    "Test is currently running. Please wait." : "Il test è attualmente in esecuzione. Attendi.",
    "Allow Group Linking:" : "Consenti collegamento dei gruppi:",
