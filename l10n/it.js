OC.L10N.register(
    ...
    "This account is already a member of the circle" : "Questo account è già un membro della cerchia",
    ...
    "%s (Circle owned by %s)" : "%s (Cerchi di proprietà di %s)",
