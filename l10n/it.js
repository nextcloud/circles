OC.L10N.register(
    "circles",
    {
    "You created the team {circle}" : "Hai creato il team {circle}",
    "{author} created the team {circle}" : "{author} ha creato il team {circle}",
    "You deleted {circle}" : "Hai eliminato {circle}",
    "{author} deleted {circle}" : "{author} ha eliminato {circle}",
    "You made {member} join {circle}" : "Hai fatto {member} entrare in {circle}",
    "{author} made {member} join {circle}" : "{author} ha fatto {member} entrare in {circle}",
    "You added team {member} as member to {circle}" : "Hai aggiunto team {member} come membro di {circle}",
    "{author} added team {member} as member to {circle}" : "{author} ha aggiunto team {member} come membro di {circle}",
    "You made {member} leave {circle}" : "Hai fatto {member} uscire da {circle}",
    "{author} made {member} leave {circle}" : "{author} ha fatto {member} uscire da {circle}",
    ...
    "Teams" : "Team",
    "On events happening in a <strong>team</strong> of which you are a member" : "Sugli eventi che accadono in un <strong>team</strong> di cui sei membro",
    "Any important event in a <strong>team</strong> you are moderating" : "Qualsiasi evento importante in un <strong>team</strong> che stai moderando",
    "On global events happening in any <strong>team</strong>" : "Sugli eventi globali che accadono in qualsiasi <strong>team</strong>",
    "Single" : "Singola",
    "Personal" : "Personale",
    "System" : "Sistema",
    "Visible" : "Visibile",
    "Open" : "Apri",
    "Invite" : "Invita",
    "Join request" : "Richiesta di adesione",
    "Friends" : "Amici",
    ...
    "Local" : "Locale",
    "Root" : "Radice",
    "Team invite" : "Invito dal team",
    "Federated" : "Federata",
    "Mount point" : "Punto di mount",
    "Nextcloud Account" : "Account Nextcloud",
    ...
    "Teams App" : "App Teams",
    "Admin Command Line" : "Riga di comando amministratore",
    "Member" : "Membro",
    ...
    "Files" : "File",
    "This feature is not available for personal teams" : "Questa funzionalità non è disponibile nei team personali",
    "The team is not federated" : "Il team non è federato",
    "You cannot join this team" : "Non puoi unirti a questo team",
    ...
    "This member is the owner of the team" : "Questo membro è il proprietario del team",
    "Level cannot be changed for this type of member" : "Il livello non può essere modificato per questo tipo di membro",
    "You are already a member of this team" : "Sei già un membro di questo team",
    "You have been blocked from this team" : "Sei stato bloccato da questo team",
    "The account is already a member of this team" : "L'account è già membro di questo team",
    "The account has already been invited into this team" : "L'account è già stato invitato in questo team",
    "%s (Team owned by %s)" : "%s (Team di proprietà di %s)",
    "You are now a member of the Team \"%2$s\"" : "Ora sei un membro del Team \"%2$s\"",
    "You have been invited by %1$s into the Team \"%2$s\"" : "Sei stato invitato da %1$s dentro al Team \"%2$s\"",
    "%1$s sent a request to be a member of the Team \"%2$s\"" : "%1$s ha inviato una richiesta per diventare membro del Team \"%2$s\"",
    "Accept" : "Accetta",
    "Refuse" : "Rifiuta",
    ...
    "You have no permission to create a new team" : "Non hai il permesso di creare un nuovo team",
    "%s shared a file with \"%s\"." : "%s ha condiviso un file con \"%s\".",
    "%s shared a file with you." : "%s ha condiviso un file con te.",
    "%1$s shared %2$s with %3$s" : "%1$s condiviso %2$s con %3$s",
    "%1$s shared %2$s with \"%3$s\"" : "%1$s condiviso %2$s con \"%3$s\"",
    "Open %s" : "Apri %s",
    ...
    "Join or create teams to see them here." : "Unisciti o crea dei team per vederli qui.",
    "Create your first team" : "Crea il tuo primo team",
    "Loading…" : "Caricamento…",
    "More teams" : "Altri team",
    ...
    "The account is already a member of this circle" : "L'account è già membro di questa cerchia",
    "The account has already been invited into this circle" : "L'account è già stato invitato in questa cerchia"
},
