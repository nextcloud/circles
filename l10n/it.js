OC.L10N.register(
    "circles",
    {
    "Circles uses its own method to async heavy processes." : "Cerchie utilizza il suo metodo per rendere asincroni i processi onerosi.",
    ...
    "Anyone can find and request an invitation to the circle; but only members will see who\\'s in it and get access to it\\'s shared items." : "Chiunque può trovare la cerchia e richiedere un invito, ma solo i membri vedranno chi vi partecipa e accedere agli elementi condivisi.",
    ...
    "initiate async test in Circles" : "inizia il test di Cerchie asincrono",
    "reset test result" : "ripristina i risultati del test",
    "Test underway. Please wait." : "Il test è attualmente in esecuzione. Attendi.",
