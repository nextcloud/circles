OC.L10N.register(
    ...
    "You sent a request to link {circle} with {remote}" : "Hai inviato una richiesta di collegare {circle} con {remote}",
    "{remote} requested a link with {circle}" : "{remote} ha richiesto un collegamento con {circle}",
    "You canceled the request to link {circle} with {remote}" : "Hai annullato la richiesta di collegare {circle} con {remote}",
    "{author} canceled the request to link {circle} with {remote}" : "{author} ha annullato la richiesta di collegare {circle} con {remote}",
    "You accepted the request to link {remote} with {circle}" : "Hai accettato la richiesta di collegare {remote} con {circle}",
    "{author} accepted the request to link {remote} with {circle}" : "{author} ha accettato la richiesta di collegare {remote} con {circle}",
