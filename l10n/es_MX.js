OC.L10N.register(
    ...
    "This operation will add/invite every members from the group to the circle" : "Esta operación agregará/invitará a todos los miembros del grupo al círculo",
    ...
    "Members from group '{name}' successfully added to the circle" : "Los miembros del grupo '{name}' fueron agregados exitosamente al círculo",
    "Members from group '{name}' could not be added to the circle" : "Los miembros del grupo '{name}' no pudieron ser agregados al círculo",
    ...
    "Create a hidden circle" : "Crear un círculo secreto",
    ...
    "This is the right option if you want to do recurrent sharing with the same group." : "Esta es la opción indicada si deseas compartir recurrentemente con el mismo grupo. ",
    "An hidden circle is an open group that can be protected by a password." : "Un círculo oculto es un grupo abierto que puede ser protegido por una contraseña. ",
    ...
    "This is the right circle if you are looking for privacy when sharing your files or ideas." : "Este es el círculo indicado si estás buscando privacidad al compartir tus archivos o ideas",
    ...
    "Everyone will be able to see and join your circle." : "Todos podrán ver y unirse a tu círculo",
