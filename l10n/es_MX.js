OC.L10N.register(
    ...
    "You rejected the invitation to join {circle}" : "Rechazaste la invitación para unirte a {cirlce}",
    "{member} rejected the invitation to join {circle}" : "{member} rechazó la invitación para unirse a {circle}",
