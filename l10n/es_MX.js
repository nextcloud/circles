OC.L10N.register(
    ...
    "You shared a mood with %1$s" : "Compartiste un mood con %1$s",
    "You shared a mood with {circles}" : "Compartiste un mood con {circles}",
    "%1$s shared a mood with %2$s" : "%1$s compartió un mood con %2$s",
    "{author} shared a mood with {circles}" : "{author} compartió un mood con {circles}",
