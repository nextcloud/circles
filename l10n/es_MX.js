OC.L10N.register(
    ...
    "You have successfully joined this circle" : "Te has unido exitosamente a este círculo",
    "You have requested to join this circle" : "Has solicitado unirte a este círculo",
    "You have successfully left this circle" : "Has dejado exitosamente este círculo",
    "Cannot leave this circle" : "No puedes dejar este círculo",
    "You have successfully deleted this circle" : "Has borrado exitosamente este círculo",
    ...
    "The member '{name}' was included in the circle" : "El miembro '{name}' se incluyó al círculo",
    "The member '{name}' could not be included in the circle" : "El miembro '{name}' no pudo ser incluido al círculo",
    "Members of the group '{name}' were included in the circle" : "Miembros del grupo '{name}' se incluyeron al círculo",
    "Members of the group '{name}' could not be included in the circle" : "Miembros del grupo '{name}' no pudieron ser incluidos al círculo",
    ...
    "It seems that you are trying to link a circle to itself" : "Parece que estás tratando de ligar un círculo a sí mismo",
