OC.L10N.register(
    ...
    "{author} has requested an invitation into {circle}" : "{author} ha pedido que lo inviten a {circle}",
    "You joined {circle}" : "Te uniste a {circle}",
    "{member} has joined the circle {circle}" : "{member} se unió al círculo {circle}",
    ...
    "{member} has left {circle}" : "{member} ha dejado {circle}",
