OC.L10N.register(
    ...
    "You were added as member to {circle} by {author}" : "Ju u shtuat si anëtar në {circle} nga {author}",
    "{member} was added as member to {circle} by {author}" : "{member} u shtua si anëtar në {circle} nga {author}",
    ...
    "You were removed from {circle} by {author}" : "Ju jeni hequr nga {circle} nga {author}",
    "{member} was removed from {circle} by {author}" : "{member} u hoq nga {circle} nga {author}",
    "You linked {group} to {circle}" : "Ju lidhët {group} me {circle}",
    "{group} was linked to {circle} by {author}" : "{group} u lidh me {circle} nga {author}",
    "You unlinked {group} from {circle}" : "You shkëputët {group} nga {circle}",
    "{group} was unlinked from {circle} by {author}" : "{group} u shkëput nga {circle} nga {author}",
    ...
    "You invited {member} into {circle}" : "Ju ftuat {member} në {circle}",
    "You have been invited into {circle} by {author}" : "Ju jeni ftuar në {circle} nga {author}",
    "{member} have been invited into {circle} by {author}" : "{member} është ftuar në {circle} nga {author}",
    ...
    "You requested an invitation into {circle}" : "Ju kërkuat një ftesë në {circle}",
    "{member} has requested an invitation into {circle}" : "{member} ka kërkuar një ftesë në {circle}",
    ...
    "Create a hidden circle" : "Krijo një rreth të fshehtë",
    ...
    "This is the right option if you want to do recurrent sharing with the same group." : "Ky është opsioni i duhur nëse doni të bëni ndarje të përsëritur me të njëjtin grup.",
    ...
    "A private circle requires invitation or confirmation by an admin." : "Një rreth privat kërkon ftesë ose konfirmim nga një administrator.",
    "This is the right circle if you are looking for privacy when sharing your files or ideas." : "Ky është rrethi i duhur nëse kërkoni privatësi kur ndani skedarët ose idetë tuaja.",
