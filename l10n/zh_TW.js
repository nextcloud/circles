OC.L10N.register(
    ...
    "Optional, you can also add members later" : "選擇性，您也可以稍後再新增成員",
    ...
    "Team space breadcrumbs" : "團隊空間頁面路徑",
    ...
    "Empty folder" : "空資料夾",
    "This team space is empty." : "此團隊空間為空",
    ...
    "Team space unavailable" : "團隊空間無法使用",
    ...
    "Automatically create a shared team space when a new team is created. Requires the Team Folders app to be installed and enabled." : "建立新團隊時，自動建立共享的團隊空間。此功能需先安裝並啟用「團隊資料夾」應用程式。",
