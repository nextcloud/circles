OC.L10N.register(
    ...
    "Changed default team space quota" : "已變更預設團隊空間配額",
    "Quota must be a non-negative number." : "配額必須為非負數字。",
    "Configure the default storage quota for team spaces. Requires the Team Folders app to be installed and enabled." : "設定團隊空間的預設儲存空間配額。此功能需先安裝並啟用「團隊資料夾」應用程式。",
