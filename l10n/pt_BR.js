OC.L10N.register(
    ...
    "Unlimited" : "Ilimitado",
    "Unable to update team space config" : "Não foi possível atualizar a configuração do espaço de equipe",
    "Changed default team space quota" : "Alteração da cota padrão do espaço de equipe",
    ...
    "Save" : "Salvar",
    "Default storage quota applied to each auto-created team space. Use 0 for unlimited storage." : "Cota de armazenamento padrão aplicada a cada espaço de equipe criado automaticamente. Use 0 para armazenamento ilimitado.",
    ...
    "Optional, you can also add members later" : "Opcional; você também pode adicionar membros posteriormente",
    ...
    "This team space is empty." : "Este espaço de equipe está vazio.",
    ...
    "Could not load team space" : "Não foi possível carregar o espaço de equipe",
    "Could not create the team space" : "Não foi possível criar o espaço de equipe",
    ...
    "Team space unavailable" : "Espaço de equipe indisponível",
    "Could not load the team space. Please try again later." : "Não foi possível carregar o espaço de equipe. Tente novamente mais tarde.",
    ...
    "Automatically create a shared team space when a new team is created. Requires the Team Folders app to be installed and enabled." : "Crie automaticamente um espaço de equipe compartilhado quando uma nova equipe for criada. É necessário que o aplicativo Pastas de equipe esteja instalado e ativado.",
    "Automatically create a team space" : "Criar automaticamente um espaço de equipe",
    "Team space" : "Espaço de equipe",
    "Create a shared team space for this team." : "Crie um espaço de equipe compartilhado para essa equipe.",
    "New folder" : "Nova pasta",
    "Folder name" : "Nome da pasta",
    "This will create a regular folder shared with the team." : "Isso criará uma pasta comum compartilhada com a equipe.",
