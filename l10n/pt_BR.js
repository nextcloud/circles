OC.L10N.register(
    ...
    "{author} added team {member} as member to {circle}" : "{autor} Equipe adicionada {membro} como membro da {circle}",
    ...
    "{author} removed {member} from {circle}" : "{author} removido {membro} de {circle}",
    ...
    "{member} cancelled a request to join {circle}" : "{member} cancelou uma solicitação para ingressar em {circle}",
    ...
    "On events happening in a <strong>team</strong> of which you are a member" : "Em eventos que acontecem em um <strong>equipe</strong> do qual você é membro",
    ...
    "Create a new team" : "Crie uma nova equipe",
    "Files" : "Arquivos",
    ...
    "You have been invited by %1$s into the Team \"%2$s\"" : "Você foi convidado por %1$s para a equipe \"%2$s\"",
    ...
    "You added circle {member} as member to {circle}" : "Você adicionou o círculo {member} como membro de {circle}",
    "{author} added circle {member} has been added as member to {circle}" : "{author} adicionou a equipe {member} como membro de {circle}",
    "You removed {member} leave {circle}" : "Você removeu {member}, saiu de {circle}",
    ...
    "Select team to filter by" : "Selecione a equipe para filtrar",
