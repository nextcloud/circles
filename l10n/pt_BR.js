OC.L10N.register(
    ...
    "The member '{name}' was included in the circle" : "O membro '{name}' foi incluído no círculo",
    "The member '{name}' could not be included in the circle" : "O membro '{name}' não pôde ser incluído no círculo",
    "Members of the group '{name}' were included in the circle" : "Membros do grupo '{name}' foram incluídos no círculo",
    "Members of the group '{name}' could not be included in the circle" : "Membros do grupo '{name}' não puderam ser incluídos no círculo",
