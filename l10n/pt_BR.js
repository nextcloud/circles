OC.L10N.register(
    ...
    "You rejected the invitation to join {circle}" : "Você recusou o convite para juntar-se à {circle}",
    "{member} rejected the invitation to join {circle}" : "{member} rejeitou o convite para juntar-se à {circle}",
