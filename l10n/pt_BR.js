OC.L10N.register(
    ...
    "the link to <b>{remote}</b> is now up and running." : "O link para <b>{remote}</b> está ok e rodando agora.",
    ...
    "You shared a mood with %1$s" : "Você compartilhou um status com %1$s",
    "You shared a mood with {circles}" : "Você compartilhou um status com {circles}",
    "%1$s shared a mood with %2$s" : "%1$s compartilhou um status com %2$s",
    "{author} shared a mood with {circles}" : "{author} compartilhou um status com {circles}",
