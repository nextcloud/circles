OC.L10N.register(
    ...
    "{author} added team {member} has been added as member to {circle}" : "{author} adicionou equipe {member} foi adicionado como membro de {circle}",
    ...
    "{author} added circle {member} has been added as member to {circle}" : "{author} adicionou círculo {member} foi adicionado como membro de {circle}",
