OC.L10N.register(
    ...
    "{group} was linked to {circle} by {author}" : "{group} foi linkado com {circle} por {author}",
    "You unlinked {group} from {circle}" : "você removeu o link de {group} com {circle}",
    "{group} was unlinked from {circle} by {author}" : "Foi removido o link de {group} com {circle} por {author}",
