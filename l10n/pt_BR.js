OC.L10N.register(
    ...
    "Member '{name}' successfully added to the circle" : "Usuário '{name}' adicionado ao círculo",
    "Member '{name}' could not be added to the circle" : "Não foi possível adicionar o membro '{name}' a este círculo",
    "Member '{name}' successfully removed from the circle" : "Usuário '{name}' excluído do círculo",
    ...
    "{author} has requested an invitation into {circle}" : "{author} solicitou um convite para {circle}",
    "You joined {circle}" : "Você juntou-se a {circle}",
    "{member} has joined the circle {circle}" : "{member} juntou-se ao círculo {circle}",
    ...
    "{member} has left {circle}" : "{member} saiu de {circle}",
