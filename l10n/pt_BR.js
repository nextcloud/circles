OC.L10N.register(
    ...
    "Open »%s«" : "Abrir »%s«",
    "%1$s shared multiple files with you.\nYou should have already received a separate mail with a link to access them.\n" : "%1$scompartilhou vários arquivos com você .\nVocê já deveria ter recebido um e-mail separado com um link para acessá-los.\n",
    "%1$s shared multiple files with you. You should have already received a separate mail with a link to access them." : "%1$scompartilhou vários arquivos com você. Você deve ter recebido um e-mail separado com um link para acessá-los. ",
    ...
    "%s shared multiple files with '%s'." : "%scompartilhou vários arquivos com  '%s'.",
    "%s shared multiple files with you." : "%scompartilhou vários arquivos com você. ",
