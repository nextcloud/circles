OC.L10N.register(
    ...
    "You cancelled {member}'s invitation to join {circle}" : "{member} kullanıcısına gönderilen {circle} çevresine katılma davetini iptal ettiniz",
    ...
    "{author} cancelled {member}'s invitation to join {circle}" : "{author}, {member} kullanıcısına gönderilen {circle} çevresine katılma davetini iptal etti",
