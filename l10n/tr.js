OC.L10N.register(
    ...
    "You created the team {circle}" : "{circle} çevresini eklediniz",
    "{author} created the team {circle}" : "{author}, {circle} çevresini ekledi",
    "You deleted {circle}" : "{circle} çevresini sildiniz",
    "{author} deleted {circle}" : "{author}, {circle} çevresini sildi",
    "You made {member} join {circle}" : "{member} üyesini {circle} çevresine kattınız",
    "{author} made {member} join {circle}" : "{author}, {member} üyesini {circle} çevresine kattı",
    "You added team {member} as member to {circle}" : "{member} üyesini {circle} çevresine eklediniz",
    "{author} added team {member} has been added as member to {circle}" : "{author}, {member} takım üyesini {circle} çevresine ekledi",
    "You made {member} leave {circle}" : "{member} üyesini {circle} çevresinden çıkardınız",
    "{author} made {member} leave {circle}" : "{author}, {member} üyesini {circle} çevresinden çıkardı",
    "You removed {member} leave {circle}" : "{member} üyesini {circle} çevresinden çıkardınız",
    "You joined {circle}" : "{circle} çevresine katıldınız",
    "{member} joined {circle}" : "{member}, {circle} çevresine katıldı",
    "You accepted the invitation to join {circle}" : "{circle} çevresine katılma davetini kabul ettiniz",
    "{member} accepted the invitation to join {circle}" : "{member}, {circle} çevresine katılma davetini kabul etti",
    "You added {member} as member to {circle}" : "{member} üyesini {circle} çevresine eklediniz",
    ...
    "You accepted {member}'s request to join {circle}" : "{member} üyesinin {circle} çevresine katılma isteğini kabul ettiniz",
    "Your request to join {circle} has been accepted by {author}" : "{circle} çevresine katılma isteğiniz {author} tarafından kabul edildi",
    "{member}'s request to join {circle} has been accepted by {author}" : "{member} üyesinin {circle} çevresine katılma isteği  {author} tarafından kabul edildi",
    "You left {circle}" : "{circle} çevresinden ayrıldınız",
    "{member} left {circle}" : "{member}, {circle} çevresinden ayrıldı",
    "You declined the invitation to join {circle}" : "{circle} çevresine katılma davetini geri çevirdiniz",
    "{member} declined an invitation to join {circle}" : "{member}, {circle} çevresine katılma davetini geri çevirdi",
    "You cancelled your request to join {circle}" : "{circle} çevresine gönderdiğiniz katılma isteğini iptal ettiniz",
    "{member} cancelled a request to join {circle}" : "{member}, {circle} çevresine gönderdiği katılma isteğini iptal etti",
    "You removed {member} from {circle}" : "{member} üyesini {circle} çevresinden çıkardınız",
    ...
    "You cancelled {member}'s invitation to join {circle}" : "{member} üyesine gönderilen {circle} çevresine katılma davetini iptal ettiniz",
    "Your invitation to join {circle} has been cancelled by {author}" : "{circle} çevresine katılmanız için yapılan davet {author} tarafından iptal edildi",
    "{author} cancelled {member}'s invitation to join {circle}" : "{author}, {member} üyesine gönderilen {circle} çevresine katılma davetini iptal etti",
    "You dismissed {member}'s request to join {circle}" : "{member} üyesinin {circle} çevresine katılma isteğini reddettiniz",
    ...
    "{member}'s request to join {circle} has been dismissed by {author}" : "{member} üyesinin {circle} çevresine katılma isteği  {author} tarafından reddedildi",
    "You invited {member} to join {circle}" : "{member} üyesini {circle} çevresine katılmaya çağırdınız",
    "You have been invited to join {circle} by {author}" : "{author} tarafından {circle} çevresine katılmaya davet edildiniz",
    "{member} has been invited to join {circle} by {author}" : "{member}, {author} tarafından {circle} çevresine katılmaya davet edildi",
    "You changed {member}'s level in {circle} to %1$s" : "{member} üyesinin {circle} çevresindeki düzeyini %1$s olarak değiştirdiniz",
    "{author} changed your level in {circle} to %1$s" : "{author}, circle} çevresindeki düzeyinizi %1$s olarak değiştirdi",
    "{author} changed {member}'s level in {circle} to %1$s" : "{author}, {member} üyesinin {circle} çevresindeki düzeyini %1$s olarak değiştirdi",
    "You sent a request to join {circle}" : "{circle} çevresine katılma isteği gönderdiniz",
    "{member} sent a request to join {circle}" : "{member} üyesi {circle} çevresine katılma isteği gönderdi",
    ...
    "The account has already been invited into this circle" : "Hesap zaten bu çevreye girmesi için davet edilmiş",
    "%s (Team owned by %s)" : "%s (Takım sahibi %s)",
    "You are now a member of the Circle \"%2$s\"" : "Artık \"%2$s\" çevresinin üyesisiniz",
    "You have been invited by %1$s into the Circle \"%2$s\"" : "%1$s tarafından \"%2$s\" çevresine davet edildiniz",
    ...
    "You added circle {member} as member to {circle}" : "{member} takım üyesini {circle} çevresine eklediniz",
    "{author} added circle {member} has been added as member to {circle}" : "{author}, {member} çevre üyesini {circle} çevresine ekledi",
