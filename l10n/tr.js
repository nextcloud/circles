OC.L10N.register(
    ...
    "The request to link {circle} with {remote} has been accepted" : "{circle} çevresi için {remote} tarafından yapılan bağlantı isteğini kabul ettiniz",
    ...
    "{author} accepted the request to link {remote} with {circle}" : "{author}, {remote} tarafından yapılan {circle} çevresi ile bağlantı isteğini kabul etti",
    ...
    "You accepted the invitation to join {circle}" : "{circle} çevresine katılma çağrısını kabul ettiniz",
    "{member} accepted the invitation to join {circle}" : "{member}, {circle} çevresine katılma çağrısını kabul etti",
    ...
    "You accepted {member}'s request to join {circle}" : "{member} kullanıcısının {circle} çevresine katılma isteğini kabul ettiniz",
    "Your request to join {circle} has been accepted by {author}" : "{circle} çevresine yaptığınız katılma isteği {author} tarafından kabul edildi",
    "{member}'s request to join {circle} has been accepted by {author}" : "{member} kullanıcısının {circle} çevresine katılma isteği  {author} tarafından kabul edildi",
    ...
    "Accept" : "Kabul Et",
    "Refuse" : "Reddet",
    "Leave the circle" : "Çevreden ayrıl",
    ...
    "Accept Link Request Automatically" : "Bağlantı İsteği Otomatik Olarak Kabul Edilsin",
