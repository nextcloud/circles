OC.L10N.register(
    ...
    "{author} has requested an invitation into {circle}" : "{author}, {circle} çevresine katılma çağrısı aldı",
    "You joined {circle}" : "{circle} çevresine katıldınız",
    "{member} has joined the circle {circle}" : "{member}, {circle} çevresine katıldı",
    ...
    "{member} has left {circle}" : "{member}, {circle} çevresinden ayrıldı",
