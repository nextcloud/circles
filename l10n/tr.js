OC.L10N.register(
    "circles",
    {
    "Circles uses its own method to async heavy processes." : "Çevreler eşitlenmemiş ağır işlemler için kendi yöntemini kullanır",
    ...
    "The user has already been invited into this circle" : "Kullanıcı zaten bu çevreye katılmaya çağrılmış",
    ...
    "Joining a closed circle requires an invitation or confirmation by a moderator." : "Kapalı bir çevreye katılmak için bir çağrı alınması ya da sorumlu onayı gerekir.",
    "Anyone can find and request an invitation to the circle; but only members will see who\\'s in it and get access to it\\'s shared items." : "Herkes çevreyi bulup katılma isteği gönderebilir ancak yalnız üyeler çevredeki diğer kişileri görebilir ve çevrede paylaşılan ögelere erişebilir.",
    ...
    "Anyone can see, join, and access the items shared within the circle." : "Herkes çevreyi görebilir, katılabilir ve çevrede paylaşılan ögelere erişebilir.",
    ...
    "Makes the circle federated, and enables sharing between federated circles" : "Çevreyi Birleşmiş yapar ve Birleşmiş Çevreler arasında paylaşımı etkinleştirir.",
    ...
    "initiate async test in Circles" : "Eşitlenmemiş Çevreler Sınaması Başlat",
    "reset test result" : "sınama sonuçlarını sıfırla",
    "Test underway. Please wait." : "Sınama sürüyor. Lütfen bekleyin.",
