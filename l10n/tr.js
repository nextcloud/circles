OC.L10N.register(
    ...
    "{group} was linked to {circle} by {author}" : "{group} grubu {circle} çevresine {author} tarafından bağlandı",
    "You unlinked {group} from {circle}" : "{group} grubunun {circle} çevresiyle bağlantısını kaldırdınız",
    "{group} was unlinked from {circle} by {author}" : "{group} grubunun {circle} çevresiyle bağlantısı {author} tarafından kaldırıldı",
