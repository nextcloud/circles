OC.L10N.register(
    ...
    "You rejected the invitation to join {circle}" : "{circle} çevresine katılma çağrısını reddettiniz",
    "{member} rejected the invitation to join {circle}" : "{member}, {circle} çevresine katılma çağrısını reddetti",
