OC.L10N.register(
    ...
    "This member is not an admin of the circle" : "该成员不是此圈子的管理员",
    ...
    "Anyone can find and request an invitation to the circle; but only members will see who\\'s in it and get access to it\\'s shared items." : "任何人都可以查找到圈子并请求加入; 但只有成员才能看到圈子的成员和访问圈子里共享的项目。",
