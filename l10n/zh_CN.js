OC.L10N.register(
    ...
    "%1$s shared »%2$s« with you. You should have already received a separate mail with a link to access it." : "%1$s 与您分享了 »%2$s«。您应已收到一封单独的带有访问链接的邮件。",
    ...
    "%1$s shared multiple files with you. You should have already received a separate mail with a link to access them." : "%1$s 与您分享了多个文件。您应已收到一封单独的带有访问链接的邮件。",
    "Password to access files shared to you by %1$s" : "使用密码访问由 %1$s 共享给您的文件",
    "Password to access files" : "用以访问文件的密码",
    "%s shared multiple files with '%s'." : "%s 与 '%s' 共享了多个文件。",
    "%s shared multiple files with you." : "%s 与您共享了多个文件。",
