OC.L10N.register(
    ...
    "%s shared »%s« with you." : "%s kuhavigis „%s“ kun vi.",
    ...
    "Circles allows your users to create their own groups of users/colleagues/friends.\nThose groups of users (or 'circles') can then be used by any other app for sharing purpose (files, social feed, status update, messaging, ...).\n\nDifferent type of circles can be created:\n\n- A personal circle is a list of users known only to the owner.\nThis is the right option if you want to do recurrent sharing with the same group of people.\n\n- A public circle is an open group visible to anyone willing to join.\nYour circle will be visible to everyone and everyone will be able to join the circle.\n\n- A closed circle requires invitation or confirmation by an admin.\nThis is the right circle if you are looking for privacy when sharing your files or ideas.\n\n- An Secret circle is an open group that can be protected by a password.\nUsers won't be able to find this Circle using Nextcloud search engine." : "Rondoj ebligas viajn uzantojn krei siajn grupojn de uzantoj, kolegoj, amikoj.\nTiujn grupojn de uzantoj (aŭ „rondoj“) povas tiam uzi iu ajn aplikaĵo kun la celo de kunhavigo (dosieroj, sociaj fluoj, stata ĝisdatigo, mesaĝado...).\n\nPlurajn tipojn de rondoj oni povas krei:\n\n— Persona rondo estas listo de uzantoj nur konita de la posedanto.\nEstas la bona elekto, se vi volas kutime komuniki kun la sama grupo de homoj.\n\n— Publika rondo estas malferma grupo videbla de ĉiuj, kiuj volas membriĝi.\nVia rondo estos videbla de ĉiuj kaj ĉiuj povos membriĝi al la rondo.\n\n— Fermita rondo bezonas inviton aŭ konfirmon de administranto.\nEstas la taŭga rondo, se vi bezonas privatecon, kiam vi kunhavigas viajn dosierojn aŭ ideojn.\n\n— Sekreta rondo esta malfermita grupo protektebla per pasvorto.\nUzantoj ne eblos trovi tian rondon per la serĉilo de Nextcloud.",
    ...
    "Anyone can find and request an invitation to the circle; but only members will see who\\'s in it and get access to it\\'s shared items." : "Ĉiu povas trovi la rondon kaj peti inviton al ĝi; sed nur membroj vidos, kiu estas membro, kaj aliros al ĝia kunhavigitaj elementoj.",
    ...
    "Members limit:" : "Maksimuma nombro da membroj:",
    "Default limit to the number of members in a circle." : "Defaŭlta maksimumo da membroj en unu rondo",
    "Allow linking of groups:" : "Permesi interligi grupojn:",
    "Allow federated circles:" : "Permesi federajn rondojn:"
},
