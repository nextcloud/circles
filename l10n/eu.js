OC.L10N.register(
    ...
    "You are now a member of the Team \"%2$s\"" : "«%2$s» taldearen kide zara orain",
    "You have been invited by %1$s into the Team \"%2$s\"" : "%1$s(e)k «%2$s» taldera gonbidatu zaitu",
    "%1$s sent a request to be a member of the Team \"%2$s\"" : "%1$s(e)k «%2$s» taldearen kide izateko eskaera bidali du",
    "Accept" : "Onartu",
    "Refuse" : "Ukatu",
    "Leave the team" : "Utzi taldea",
    "%s" : "%s",
