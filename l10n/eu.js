OC.L10N.register(
    ...
    "Please select teams to filter by" : "Hautatu taldeak iragazteko",
    "No files found for the selected teams" : "Ez da fitxategirik aurkitu hautatutako taldeetarako",
    "You created the team {circle}" : "{circle} taldea zuk sortu duzu",
    "{author} created the team {circle}" : "{author}(e)k {circle} taldea sortu du",
    ...
    "You added team {member} as member to {circle}" : "{member} taldea gehitu duzu kide gisa {circle}(e)ra",
    "{author} added team {member} has been added as member to {circle}" : "{author}(e)k {member} taldea gehitu du kide bezala {circle}(e)ra",
    ...
    "On events happening in a <strong>team</strong> of which you are a member" : "Kide zaren <strong>talde</strong> bateko gertaeretan",
    "Any important event in a <strong>team</strong> you are moderating" : "Moderatzen ari zaren <strong>talde</strong> bateko edozein gertaera garrantzitsu",
    "On global events happening in any <strong>team</strong>" : "<strong>Talde</strong> batean gertatzen diren gertaera orokorretan",
    ...
    "The team is not federated" : "Taldea ez dago federatuta",
    "You cannot join this team" : "Ezin zara talde honetara sartu",
    ...
    "This member is the owner of the team" : "Kide hau taldearen jabea da",
    ...
    "%s (Team owned by %s)" : "%s (%s-(r)en jabetzako taldea)",
    ...
    "You have no permission to create a new team" : "Ez duzu talde berri bat sortzeko baimenik",
    ...
    "This item is already shared with this team" : "Elementu hau dagoeneko partekatu da talde honekin",
    "Bring cloud-users closer together." : "Elkartu gehiago hodei erabiltzaileak.",
    "Teams allows people to create their own groups of people/colleagues/friends.\nThose groups of people can then be used by any other app for sharing purpose." : "Teams jendeak erabiltzaile/lankide/lagun taldeak sortzen ahalbidetzen die.\nPertsona talde hauek beste aplikazio batzuetan erabili daitezke partekatzeko xedearekin.",
    ...
    "You added circle {member} as member to {circle}" : "{member} zirkulua gehitu duzu kide gisa {circle}(e)ra",
    "{author} added circle {member} has been added as member to {circle}" : "{author}(e)k {member} zirkulua gehitu du kide bezala {circle}(e)ra",
    "You removed {member} leave {circle}" : "{member} kidea {circle}(e)tik atera duzu",
