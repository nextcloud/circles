OC.L10N.register(
    ...
    "You sent a request to link {circle} with {remote}" : "Eskaera bidali duzu {circle} batzeko [remote]rekin",
    "{author} sent a request to link {circle} with {remote}" : "{author}(e)k eskaera bidali du {circle} batzeko [remote]rekin",
