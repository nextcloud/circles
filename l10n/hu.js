OC.L10N.register(
    ...
    "Contact" : "Kapcsolat",
    "Remove from circle" : "Eltávolítás a körből",
    ...
    "Global Scale User" : "Globális skála felhasználó",
    "Local User" : "Helyi felhasználó",
    "Local Group" : "Helyi csoport",
    "A new member was added to the circle" : "Új tag került a körbe",
    "Member could not be added to the circle" : "Tagot nem lehetett felvenni a körbe",
    ...
    "A new contact was added to the circle" : "Új kapcsolat került a körbe",
    "Contact could not be added to the circle" : "A kapcsolatot nem sikerült hozzáadni a körhöz",
    "A new member was invited to the circle" : "Új tagot hívtak meg a körbe",
    "Member could not be invited to the circle" : "Tagot nem lehetett meghívni a körbe",
    ...
    "On events happening in a <strong>Circle</strong> of which you are a member" : "Olyan eseményekről, amelyek egy <strong>kör</strong>ben zajlanak, amelynek tagja",
    ...
    "On global events happening in any <strong>Circle</strong>" : "Bármely <strong> Kör</strong>ben zajló globális eseményről",
    ...
    "%1$s sent a request to be a member of the Circle \"%2$s\"" : "%1$s felvételi kérelmet küldött a(z) \"%2$s\" kör tagjának",
    "Accept" : "Elfogadás",
    "Refuse" : "Megtagadás",
