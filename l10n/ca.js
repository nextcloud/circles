OC.L10N.register(
    ...
    "Issue while saving settings" : "Problemes mentre es desava la configuració",
    ...
    "On events happening in a <strong>Circle</strong> you belong" : "Sobre els esdeveniments que succeeixen en un <strong> Cercle</strong> al que pertanyeu",
    ...
    "You have been blocked from this circle" : "Heu estat bloquejats d'aquest cercle",
    ...
    "Circles allows your users to create their own groups of users/colleagues/friends.\nThose groups of users (or 'circles') can then be used by any other app for sharing purpose (files, social feed, status update, messaging, ...).\n\nDifferent type of circles can be created:\n\n- A personal circle is a list of users known only to the owner.\nThis is the right option if you want to do recurrent sharing with the same group of people.\n\n- A public circle is an open group visible to anyone willing to join.\nYour circle will be visible to everyone and everyone will be able to join the circle.\n\n- A closed circle requires invitation or confirmation by an admin.\nThis is the right circle if you are looking for privacy when sharing your files or ideas.\n\n- An Secret circle is an open group that can be protected by a password.\nUsers won't be able to find this Circle using Nextcloud search engine." : "El cercles permeten als vostres usuaris crear els seus propis grups d'usuaris/col·legues/amics.\nAquests grups d'usuaris (o 'cercles') poden així doncs ser fets servir per qualsevol aplicació per compartir propòsits (fitxers, fonts socials, actualització d'estat, missatgeria, ...).\n\nEs poden crear diferents tipus de cercles:\n\n- Un cercle personal és una llista d'usuaris coneguts només pel propietari.\nAquesta és la opció ideal si voleu compartir de tot amb el mateix grup de gent.\n\n- Un cercle públic és un grup obert visible per qualsevol que s'hi vulgui afegir.\nEl vostre cercle serà visible per tothom i tothom s'hi podrà afegir.\n\n- Un cercle tancat requereix una invitació o confirmació per un administrador.\nÉs un cercle adequat si el que busqueu és privadesa quan compartiu els vostres fitxers o idees.\n\n- Un cercle Secret és un grup obert que pot ser protegit per una contrasenya.\n\nEls usuaris no podran trobar aquest Cercle encara que facin servir el motor de cerca de Nextcloud.",
    ...
    "Anyone can find and request an invitation to the circle; but only members will see who\\'s in it and get access to it\\'s shared items." : "Qualsevol pot trobar i demanar una invitació al cercle; però només els membres podran veure qui hi ha i tenir accés als elements compartits.",
    ...
    "Join this circle" : "Uniu-vos al cercle",
    ...
    "Warning: Enabling this will automatically accept new link requests from other circles." : "Atenció: Activant això acceptarà automàticament noves peticions d'enllaços d'altres cercles.",
