OC.L10N.register(
    ...
    "The member '{name}' was included in the circle" : "S'ha inclòs '{name}' al cercle",
    "The member '{name}' could not be included in the circle" : "No s'ha pogut incloure '{name}' al cercle",
    "Members of the group '{name}' were included in the circle" : "S'han inclòs membres del grup '{name}' al cercle",
    "Members of the group '{name}' could not be included in the circle" : "No s'han pogut incloure membres del grup '{name}' al cercle",
    ...
    "You have been invited into {circle} by {author}" : "{author} t'ha convidat a {circle}  ",
    "{member} have been invited into {circle} by {author}" : "{author} ha convidat a {member} al cercle {circle}",
    ...
    "Create a hidden circle" : "Crea un cercle ocult",
