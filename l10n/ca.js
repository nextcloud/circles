OC.L10N.register(
    ...
    "This operation will add/invite every members from the group to the circle" : "Aquesta operació afegira/convidarà tots els membres del grup al cercle",
    ...
    "Members from group '{name}' successfully added to the circle" : "Els membres del grup '{name}' s'han afegit amb èxit al cercle",
    "Members from group '{name}' could not be added to the circle" : "Els membres del grup '{name}' no s'han pogut afegir al cercle",
    ...
    "You joined {circle}" : "T'has unitat a {circle}",
    ...
    "You were added as member to {circle} by {author}" : "Has estat afegit al com a membre al cercle {circle} per {author}",
    "{member} was added as member to {circle} by {author}" : "{member} ha estat afegit a {circle} per {author}",
