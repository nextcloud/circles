OC.L10N.register(
    ...
    "You have successfully joined this circle" : "Úspešne ste sa pripojili k tomuto kruhu",
    "You have requested to join this circle" : "Požiadali ste o pripojenie k tomuto kruhu",
    "You have successfully left this circle" : "Opustili ste tento kruh",
    "Cannot leave this circle" : "Tento kruh nemôžete opustiť",
    "You have successfully deleted this circle" : "Úspešne ste odstránili tento kruh",
    "Cannot delete this circle" : "Tento kruh nie je možné odstrániť",
    ...
    "Member '{name}' successfully added to the circle" : "Člen '{name}' bol úspešne pridaný do kruhu",
    "Member '{name}' could not be added to the circle" : "Člen '{name}' nemohol byť pridaný do kruhu",
    "Member '{name}' successfully removed from the circle" : "Člen '{name}' bol úspešne odstránený z kruhu",
    "Member '{name}' could not be removed from the circle" : "Člen '{name}' nemohol byť odstránený do kruhu",
    "Member '{name}' updated" : "Člen '{name}' bol aktualizovaný",
    "Member '{name}' could not be updated" : "Člen '{name}' nemohol byť aktualizovaný",
    ...
    "The circle does not exist or is hidden" : "Tento kruh neexistuje, alebo je skrytý",
    ...
    "This member is not admin of the circle" : "Tento člen nie je administrátor kruhu",
