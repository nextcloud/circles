OC.L10N.register(
    ...
    "Create a team to get started." : "Zum Anfangen, ein Team erstellen.",
    "Members" : "Mitglieder",
    "_%n resource_::_%n resources_" : ["%n Ressource","%n Ressourcen"],
    ...
    "Optional, you can also add members later" : "Optional. Es können auch später noch Mitglieder hinzugefügt werden",
    ...
    "Team space breadcrumbs" : "Team-Bereich-Brotkrumen",
    ...
    "This team space is empty." : "Dieser Team-Bereich ist leer.",
    ...
    "Could not load team space" : "Team-Bereich konnte nicht geladen werden",
    "Could not create the team space" : "Team-Bereich konnte nicht erstellt werden",
    ...
    "Your teams and everything shared with them across Nextcloud." : "Ihre Teams und alles, was über Nextcloud mit ihnen geteilt wird.",
    ...
    "Team space unavailable" : "Team-Bereich nicht verfügbar",
    "Could not load the team space. Please try again later." : "Der Team-Bereich konnte nicht geladen werden. Bitte später erneut versuchen.",
    ...
    "Please confirm team leave" : "Bitte bestätigen, dass du das Team verlassen möchtest",
    ...
    "You are about to delete {circle}.\nAre you sure?" : "Du bist dabei {circle} zu löschen.\nBist du dir sicher?",
    ...
    "Automatically create a shared team space when a new team is created. Requires the Team Folders app to be installed and enabled." : "Beim Erstellen eines neuen Teams wird automatisch ein gemeinsamer Team-Bereich angelegt. Die App \"Team-Ordner\" muss installiert und aktiviert sein.",
    "Automatically create a team space" : "Automatisch einen Team-Bereich erstellen",
