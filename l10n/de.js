OC.L10N.register(
    ...
    "Quota must be a non-negative number." : "Speicherplatzkontingent muss eine nicht-negative Zahl sein.",
    ...
    "Save" : "Speichern",
    "Default storage quota applied to each auto-created team space. Use 0 for unlimited storage." : "Für jeden automatisch erstellten Team-Bereich wird ein Standard-Speicherkontingent angewendet. Verwende 0 für unbegrenzten Speicherplatz.",
    "New team" : "Neues Team",
    ...
    "Optional, you can also add members later" : "Optional kannst du auch später Mitglieder hinzufügen",
    "Search for people to add" : "Nach Personen zum Hinzufügen suchen",
    "You can always add or remove members later from the team page." : "Du kannst Mitglieder jederzeit später auf der Team-Seite hinzufügen oder entfernen.",
    ...
    "Create a shared team space for this team." : "Erstelle einen gemeinsamen Team-Bereich für dieses Team.",
    ...
    "You already requested to join the team <b>{circleName}</b>." : "Du hast bereits eine Anfrage gestellt, dem Team <b>{circleName}</b> beizutreten.",
    "Go back" : "Zurückgehen",
