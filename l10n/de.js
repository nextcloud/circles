OC.L10N.register(
    ...
    "You accepted the invitation to join {circle}" : "Du hast die Einladung akzeptiert, {circle} beizutreten",
    ...
    "You accepted {member}'s request to join {circle}" : "Du hast {member}s Anfrage angenommen, {circle} beizutreten",
    ...
    "You rejected the invitation to join {circle}" : "Du hast die Einladung {circle} beizutreten abgelehnt",
    "{member} rejected the invitation to join {circle}" : "{member} hat die Einladung {circle} beizutreten abgelehnt",
    "You left {circle}" : "Du hast {circle} verlassen",
    "{member} left {circle}" : "{member} hat {circle} verlassen",
    "You dismissed {member}'s request to join {circle}" : "Du hast {member}s Anfrage {circle} beizutreten abgelehnt",
    ...
    "{group} has been linked to {circle} by {author}" : "{group} wurde von {author} mit {circle} verlinkt",
    "You unlinked {group} from {circle}" : "Du hast die Verknüpfung der {group} mit {circle} entfernt",
    "{group} has been unlinked from {circle} by {author}" : "Link von {group} zu {circle} wurde von {author} gelöst",
    ...
    "The name of your circle must start with an alpha-numerical character" : "Der Name deines Kreises muss mit einem alphanumerischen Zeichen beginnen",
