OC.L10N.register(
    ...
    "The member '{name}' could not be invited to the circle" : "Das Mitglied '{name}' konnte zum Kreis eingeladen werden",
    ...
    "Members of the group '{name}' could not be invited to the circle" : "Mitglieder der Gruppe '{name}' konnten zum Kreis nicht eingeladen werden",
    ...
    "You linked {group} to {circle}" : "Du hast eine Verknüpfung der {group} dem {circle} hinzugefügt",
    "{group} was linked to {circle} by {author}" : "{group} wurde mit {circle} von {author} verknüpft",
    "You unlinked {group} from {circle}" : "Du hast die Verknüpfung der {group} mit {circle} entfernt",
    "{group} was unlinked from {circle} by {author}" : "Verknüpfung der {group} wurde mit {circle} von {author} entfernt",
    "You changed the level of the linked group {group} in {circle} to %1$s" : "Du hast den Rang der verknüpften Gruppe {group} im {circle} zu %1$s geändert",
    ...
    "The request to link {circle} with {remote} has been rejected" : "Die Anfrage {circle} mit {remote} zu verknüpfen wurde auf dem entfernten System zurück gewiesen",
