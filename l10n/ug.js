OC.L10N.register(
    ...
    "{author} removed {member} from {circle}" : "{author} چەمبىرەك{circle} دىن {member} نى چىقىرىلدى",
    ...
    "{author} cancelled {member}'s invitation to join {circle}" : "{author} ئەزا {member} نىڭ{circle} چەمبىرىكىگە قاتنىشىش تەكلىپىنى ئەمەلدىن قالدۇردى",
    ...
    "{member}'s request to join {circle} has been dismissed by {author}" : "{member}نىڭ {circle} گە قاتنىشىش تەلىپى {author} تەرىپىدىن رەت قىلىندى",
    ...
    "You changed {member}'s level in {circle} to %1$s" : "سىز {member}نىڭ دەرىجىسىنى {circle} دىن %1$sگە ئۆزگەرتتىڭىز",
    "{author} changed your level in {circle} to %1$s" : "{author} دەرىجىڭىزنى{circle}دىن %1$s گە ئۆزگەرتتى",
    "{author} changed {member}'s level in {circle} to %1$s" : "{author} بولسا {member}نىڭ دەرىجىسىنى {circle}دىن %1$s غا ئۆزگەرتتى",
    ...
    "Contact" : "ئالاقىلىشىڭ",
    "Team" : "ئەتىرەت",
    "Nextcloud App" : "Nextcloud ئەپ",
    "Teams App" : "ئەتىرەت ئەپ",
    "Admin Command Line" : "باشقۇرغۇچى بۇيرۇق سۇپىسى",
    "Member" : "ئەزا",
    "Moderator" : "رىياسەتچى",
    "Admin" : "باشقۇرغۇچى",
    "Owner" : "ئىگىسى",
    "%s shared »%s« with you." : " %s سىز بىلەن »%s« نى ئورتاقلاشتى",
    "%s shared »%s« with \"%s\"." : " %s بولسا \"%s\" بىلەن »%s« نى ئورتاقلاشتى",
    "%s on %s" : "%s دا %s",
    "%1$s shared »%2$s« with you.\nYou should have already received a separate email with a link to access it.\n" : "%1$s سىز بىلەن »%2$s« نى ئورتاقلاشتى.\nئۇنى زىيارەت قىلىش ئۈچۈن ئۇلانمىسى بار ئايرىم ئېلېكترونلۇق خەت تاپشۇرۇۋالغان بولۇشىڭىز كېرەك.\n",
    "%1$s shared »%2$s« with you. You should have already received a separate email with a link to access it." : " %1$s سىز بىلەن »%2$s« نى ئورتاقلاشتى. ئۇنى زىيارەت قىلىش ئۈچۈن ئۇلانمىسى بار ئايرىم ئېلېكترونلۇق خەت تاپشۇرۇۋالغان بولۇشىڭىز كېرەك.",
    "Password to access »%1$s« shared to you by %2$s" : "%2$s تەرىپىدىن سىزگە ئورتاقلاشقان »%1$s« نى پارول بىلەن ئېچىڭ",
    ...
    "Files" : "ھۆججەتلەر",
    "This feature is not available for personal teams" : "بۇ ئىقتىدار شەخسىي چەمبىرەكلەردە ئىشلىتىلمەيدۇ",
    ...
    "You are already a member of this team" : "سىز ئاللىبۇرۇن بۇ چەمبىرەكنىڭ ئەزاسى",
    "You have been blocked from this team" : "سىز بۇ چەمبىرەكتىن توسۇۋېلىندىڭىز",
    "The account is already a member of this team" : "بۇ ھېسابات ئاللىقاچان بۇ چەمبىرەكنىڭ ئەزاسى",
    "The account has already been invited into this team" : "بۇ ھېسابات ئاللىبۇرۇن بۇ چەمبىرەككە تەكلىپ قىلىنغان",
    ...
    "%1$s shared %2$s with %3$s" : "%1$s بولسا %2$s نى %3$s بىلەن ھەمبەھىرلىدى",
    "%1$s shared %2$s with \"%3$s\"" : "%1$s بولسا %2$s نى \"%3$s\" بىلەن ھەمبەھىرلىدى",
    "Open %s" : "%s نى ئېچىڭ",
    ...
    "Failed to load teams" : "ئەتىرەتلەرنى يۈكلىگىلى بولمىدى",
    "Try again" : "قايتا سىناڭ",
    "No teams found" : "ھېچقانداق كوماندا تېپىلمىدى",
    "Join or create teams to see them here." : "بۇ يەردە كۆرۈش ئۈچۈن ئەتىرەتكە قېتىلىڭ ياكى قۇرۇڭ",
    "Create your first team" : "تۇنجى ئەتىرىتىڭىزنى قۇرۇڭ",
    "Loading…" : "يۈكلەۋاتىدۇ…",
    "More teams" : "تېخىمۇ كۆپ ئەتىرەت",
