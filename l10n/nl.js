OC.L10N.register(
    ...
    "{member} accepted the invitation to join {circle}" : "{member} accepteerde de uitnodiging voor {circle}",
    ...
    "You sent a request to join {circle}" : "Je verstuurde een verzoek om lid te worden van {circle}",
    ...
    "%s shared »%s« with you." : "%sdeelde » %s « met jou.",
    ...
    "The name of your circle must start with an alpha-numerical character" : "De naam van je kring moet beginnen met een alfanumerieke karakter",
    ...
    "Level cannot be changed for that type of member" : "Toegangsniveau kan niet veranderd worden voor dit type gebruiker.",
    ...
    "User is already a member of this circle" : "Gebruiker is al lid van deze kring",
    "User is already invited into this circle" : "Gebruiker is al uitgenodigd voor deze kring",
    ...
    "Joining a closed circle requires an invitation or a confirmation by a moderator." : "Lid worden van een besloten kring vereist een uitnodiging of een bevestiging van een moderator.",
    "Anyone can find the circle and request an invitation; but only members will see who's in it and get access to shared items." : "Iedereen kan de cirkel vinden en een uitnodiging aanvragen; Maar alleen leden zien wie erin zit en toegang krijgen tot gedeelde items.",
    ...
    "Anyone can see the circle, can join the circle and access the items shared to the circle." : "Iedereen kan deze kring zien, lid worden en heeft toegang tot de items die binnen de kring zijn gedeeld.",
