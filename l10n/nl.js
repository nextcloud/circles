OC.L10N.register(
    ...
    "You made {member} leave {circle}" : "JIj creëerde {member}verlaat {circle}",
    "{author} made {member} leave {circle}" : "{author}creëerde {member}verliet {circle}",
    "You removed {member} from {circle}" : "Je hebt {member} van {circle} verwijderd",
    "{author} removed {member} from {circle}" : "{author} verwijderde {member} van {circle}",
