OC.L10N.register(
    ...
    "A link to <b>{remote}</b> could not be initiated" : "Een link naar <b>{remote}</b> kon niet worden geïnitialiseerd",
    "A link to <b>{remote}</b> has been requested." : "Er is een link naar <b>{remote}</b> aangevraagd.",
    "the link to <b>{remote}</b> is now up and running." : "de link naar <b>{remote}</b> draait nu.",
    ...
    "{author} has requested an invitation into {circle}" : "{author} heeft een verzoek voor {circle} ingediend",
    "You joined {circle}" : "Je bent lid geworden van {circle}",
    "You left {circle}" : "Je hebt {circle} verlaten",
    "{member} has left {circle}" : "{member} heeft {circle} verlaten",
    ...
    "It seems that you are trying to link a circle to itself" : "het lijkt erop dat je een Kring aan zichzelf probeert te linken",
    ...
    "Link to a circle" : "Link naar een kring",
    ...
    "Warning: enabling this will automatically accept new Link requests from other circle." : "Waarschuwing: hiermee worden nieuwe Link-aanvragen van andere cirkel automatisch aanvaard."
},
