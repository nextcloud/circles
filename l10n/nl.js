OC.L10N.register(
    "circles",
    {
    "Circles is using its own way to async heavy process." : "Kringfunctie gebruikt een eigen methode om zware processen te asynchen",
    ...
    "initiate async test in Circles" : "Async test starten in Kringen",
    "reset test result" : "testresultaat resetten",
    "Test underway. Please wait." : "Testen start bijna. Even moment alsjeblieft.",
