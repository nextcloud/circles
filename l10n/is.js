OC.L10N.register(
    "circles",
    {
    "Circles uses its own method to async heavy processes." : "Hringjahugbúnaðurinn notar sína eigin aðferð við krefjandi ósamhverf ferli (async process).",
    ...
    "initiate async test in Circles" : "ræsa prófun ósamhverfrar vinnslu í hringjum",
    "reset test result" : "núllstilla niðurstöður prófunar",
    "Test underway. Please wait." : "Prófun í gangi. Bíddu aðeins.",
