OC.L10N.register(
    ...
    "You added circle {member} as member to {circle}" : "Přidali jste tým {member} jako člena do {circle}",
    "{author} added circle {member} has been added as member to {circle}" : "{author} přidal(a) tým {member} jako člena do {circle}",
    "You removed {member} leave {circle}" : "Odebrali jste opuštění {member}účtem {circle}",
