OC.L10N.register(
    ...
    "You made {member} join {circle}" : "Přidali jste {member} do {circle}",
    "{author} made {member} join {circle}" : "{author} přidal(a) {member} do {circle}",
    "You added team {member} as member to {circle}" : "Přidali jste tým {member} jako člena do {circle}",
    "{author} added team {member} as member to {circle}" : "{author} přidal(a) tým {member} jako člena do {circle}",
    "You made {member} leave {circle}" : "Docílili jste že {member} opustil {circle}",
    "{author} made {member} leave {circle}" : "{author} docílil(a) že {member} opustil(a) {circle}",
    "You removed {member} from {circle}" : "Odebrali jste {member} z {circle}",
    "{author} removed {member} from {circle}" : "{author} odebral(a) {member} z {circle}",
    ...
    "{member} cancelled a request to join {circle}" : "{member} vzal(a) zpět svou žádost o přidání do {circle}",
    ...
    "Admin Command Line" : "Příkazový řádek správce",
    "Member" : "Člen",
    "Moderator" : "Moderátor",
    "Admin" : "Správce",
    "Owner" : "Vlastník",
    ...
    "Files" : "Soubory",
    "This feature is not available for personal teams" : "Tato funkce není pro osobní týmy dostupná",
    "The team is not federated" : "Tým není federovaný",
    "You cannot join this team" : "K tomuto týmu se nemůžete připojit",
    ...
    "This member is the owner of the team" : "Tento člen je vlastníkem tohoto týmu",
    "Level cannot be changed for this type of member" : "Úroveň nelze pro tento typ člena změnit",
    "You are already a member of this team" : "Už jste členem tohoto týmu",
    "You have been blocked from this team" : "Tento tým vás zablokoval",
    "The account is already a member of this team" : "Účet už je členem tohoto týmu",
    "The account has already been invited into this team" : "Účet už byl pozván do tohoto týmu",
    "%s (Team owned by %s)" : "%s (Tým vlastněn uživatelem %s)",
    "You are now a member of the Team \"%2$s\"" : "Nyní jste členy týmu „%2$s“",
    "You have been invited by %1$s into the Team \"%2$s\"" : "%1$s vás pozval(a) do týmu „%2$s“",
    "%1$s sent a request to be a member of the Team \"%2$s\"" : "%1$s poslal(a) žádost o to, stát se členem týmu „%2$s“",
    "Accept" : "Přijmout",
    "Refuse" : "Odmítnout",
    ...
    "You have no permission to create a new team" : "Nemáte oprávnění pro vytváření nových týmů",
    "%s shared a file with \"%s\"." : "%s nasdílel(a) soubor uživateli „%s“",
    "%s shared a file with you." : "%s vám nasdílel(a) soubor.",
    "%1$s shared %2$s with %3$s" : "%1$s nasdílel/a %2$s uživateli %3$s",
    "%1$s shared %2$s with \"%3$s\"" : "%1$s nasdílel/a %2$s uživateli „%3$s“",
    "Open %s" : "Otevřít %s",
    ...
    "Federated Teams" : "Federované týmy",
    ...
    "Unable to update federated teams config" : "Nedaří se aktualizovat nastavení federovaných týmů",
    "Invalid URL format. Please provide a valid URL." : "Neplatný formát URL Zadejte platnou URL.",
    "Changed frontal cloud URL" : "Změněna URL frontal cloud",
    "Federation allows you to share teams with other trusted servers and make them discoverable across instances." : "Federování umožňuje sdílet týmy s ostatními servery, kterým důvěřujete a činit je objevitelnými napříč instancemi.",
    "Enable federated teams" : "Zapnout federované týmy",
    "Frontal URL" : "Frontal URL",
    "https://…" : "https://…",
    "The public URL used by other instances to discover and connect to your teams." : "Veřejná URL použitá ostatními instancemi pro objevování vašich týmů a připojování se k nim.",
    "Unlimited" : "Neomezeně",
    ...
    "Step {current} of {total}" : "Krok {current} ze {total}",
    ...
    "Join or create teams to see them here." : "Aby se zde zobrazily, připojte se k týmům (nebo nějaké vytvořte).",
    "Loading…" : "Načítání …",
    "More teams" : "Další týmy",
