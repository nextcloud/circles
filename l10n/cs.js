OC.L10N.register(
    ...
    "Remove this Link" : "Odstranit toto propojení",
    "Cancel the Link request" : "Zrušit požadavek na propojení",
    "Accept the Link request" : "Přijmout požadavek na propojení",
    "Reject the Link request" : "Odmítnout požadavek na propojení",
    ...
    "The member '{name}' was included in the circle" : "Člen '{name}' byl přidán k tomuto kruhu",
    "The member '{name}' could not be included in the circle" : "Člen '{name}' nemohl být přidán k tomuto kruhu",
    "Members of the group '{name}' were included in the circle" : "Členové skupiny '{name}' byli přidáni k tomuto kruhu",
    "Members of the group '{name}' could not be included in the circle" : "Členové skupiny '{name}' nemohli být přidáni k tomuto kruhu",
    ...
    "You sent a request to link {circle} with {link}" : "Poslali jste požadavek na propojení kruhu {circle} s {link}",
    "{author} sent a request to link {circle} with {link}" : "{author} poslal požadavek na propojení kruhu {circle} s {link}",
    "{link} requested a link with {circle}" : "{link} vyžádal propojení s kruhem {circle}",
    "The request to link {circle} with {link} has been rejected" : "Požadavek na propojení kruhu {circle} s {link} byl zamítnut",
    "The request to link {link} with {circle} has been canceled remotely" : "Požadavek na propojení kruhu {circle} s {link} byl zrušen vzdálenou stranou",
    "The request to link {circle} with {link} has been accepted" : "Požadavek na propojení kruhu {circle} s {link} byl přijat",
    "You dismissed the request to link {link} with {circle}" : "Skryli jste požadavek na propojení {link} s kruhem {circle}",
    "{author} dismissed the request to link {link} with {circle}" : "{author} skryl požadavek na propojení {link} s kruhem {circle}",
    "You canceled the request to link {circle} with {link}" : "Zrušili jste požadavek na propojení {link} s kruhem {circle}",
    "{author} canceled the request to link {circle} with {link}" : "{author} zrušil požadavek na propojení {link} s kruhem {circle}",
    "You accepted the request to link {link} with {circle}" : "Přijali jste požadavek na propojení {link} s kruhem {circle}",
    "{author} accepted the request to link {link} with {circle}" : "{author} přijal požadavek na propojení {link} s kruhem {circle}",
    "A link between {circle} and {link} is now up and running" : "Propojení {link} s kruhem {circle} je nyní v provozu",
    "The link between {circle} and {link} has been shutdown remotely" : "Propojení {link} s kruhem {circle} byl vypnut vzdálenou stranou",
    "You closed the link between {circle} and {link}" : "Uzavřeli jste propojení {link} s kruhem {circle}",
    "{author} closed the link between {circle} and {link}" : "{author} uzavřel propojení {link} s kruhem {circle}",
    ...
    "Federated Link not found" : "Sdružené propojení nenalezeno",
    ...
    "The remote circle does not accept Federated Links" : "Vzdálený hostitel nepřijímá sdružená propojení",
    ...
    "Warning: enabling this will automatically accept new Link requests from other circle." : "Varování: Toto nastavení povolí automatický příjem požadavků na propojení z ostatních kruhů.",
