OC.L10N.register(
    ...
    "Please select circles to filter by" : "Vyberte kruhy, které chcete filtrovat",
    ...
    "{member} has been removed from {circle} by {author}" : "{author} odebral {member} z {circle}",
    ...
    "You are already a member of this circle" : "Už jste členem tohoto kruhu",
    "You have been blocked from this circle" : "Tento kruh vás zablokoval",
    "The user is already a member of this circle" : "Uživatel už je členem tohoto kruhu",
    "The user has already been invited into this circle" : "Uživatel už byl do tohoto kruhu pozván",
    ...
    "Warning: Enabling this will automatically accept new link requests from other circles." : "Varování: Toto nastavení povolí automatický příjem požadavků na propojení z ostatních kruhů.",
    "Save settings" : "Uložit nastavení",
    "Maximum number of members per circle" : "Nejvyšší umožněný počet členů v kroužku",
    ...
    "Circles from different Nextclouds can be linked together." : "Kroužky z různých instancí Nextcloud je možné propojit dohromady.",
    "Members limit:" : "Limit členů:",
