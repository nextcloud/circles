OC.L10N.register(
    ...
    "The member '{name}' was included in the circle" : "Medlemmet '{name}' ble lagt til i sirkelen",
    "The member '{name}' could not be included in the circle" : "Medlemmet '{name}' kunne ikke innlemmes i sirkelen",
    "Members of the group '{name}' were included in the circle" : "Medlemmer av gruppen '{name}' ble innlemmet i sirkelen",
    "Members of the group '{name}' could not be included in the circle" : "Medlemmer av gruppen '{name}'  kunne ikke innlemmes l i sirkelen",
