OC.L10N.register(
    "circles",
    {
    "Circles is using its own way to async heavy process." : "Círculos está usando su propia ruta para el proceso async",
    ...
    "The name of your circle must start with an alpha-numerical character" : "El nombre de su círculo debe comenzar con un carácter alfanumérico",
    ...
    "Level cannot be changed for that type of member" : "No se puede cambiar el nivel para ese tipo de miembro",
    ...
    "User is already invited into this circle" : "El usuario ya ha sido invitado a este círculo",
    ...
    "Joining a closed circle requires an invitation or a confirmation by a moderator." : "Unirse a un círculo cerrado requiere una invitación o una confirmación por parte de un moderador.",
    "Anyone can find the circle and request an invitation; but only members will see who's in it and get access to shared items." : "Cualquiera puede encontrar el círculo y solicitar una invitación, pero sólo los miembros verán quién está en él y tendrán acceso a los elementos compartidos.",
    ...
    "Anyone can see the circle, can join the circle and access the items shared to the circle." : "Cualquiera puede ver el círculo, unirse al círculo y acceder a los elementos compartidos del círculo.",
    ...
    "initiate test of Circles Async" : "iniciando prueba asíncrona de círculos",
    "reset test result" : "reiniciar resultado de la prueba",
    "Test is currently running. Please wait." : "Se está llevando a cabo una prueba. Por favor, espera.",
    "Allow Group Linking:" : "Permitir enlaces de grupos:",
    "Groups can be linked to Circles." : "Los grupos pueden ser enlazados con círculos.",
