...
// Contact settings
export const CONTACTS_SETTINGS: DefaultGroup = t('circles', 'Contacts settings')
...
export const CIRCLE_DESC = t('circles', 'Create your own teams for sharing. Add Nextcloud users, contacts, or anyone via email.')
...
export const CIRCLES_MEMBER_TYPES = {
	[MEMBER_TYPE_CIRCLE]: t('circles', 'Team'),
...
export const PUBLIC_CIRCLE_CONFIG = {
	...
	[t('circles', 'Invitation links')]: {
		component: CircleConfigInvitationLink,
		props: {},
	},

	[t('circles', 'Membership')]: {
		component: CircleConfigCheckboxesList,
		props: {
			configs: {
				// TODO: implement backend
				// [CIRCLE_CONFIG_CIRCLE_INVITE]: t('circles', 'Team must confirm when invited in another circle'),
				[CIRCLE_CONFIG_ROOT]: t('circles', 'Prevent teams from being a member of another team'),
			},
		},
	},

	[t('circles', 'Federation')]: {
		component: CircleConfigCheckboxesList,
		props: {
			configs: {
				[CIRCLE_CONFIG_FEDERATED]: t('circles', 'Allow federated members'),
			},
		},
	},
	...
	[t('circles', 'Privacy')]: {
		...
		props: {
			configs: {
				[CIRCLE_CONFIG_VISIBLE]: t('circles', 'Visible to everyone'),
			},
		},
	},
}
...
export const CIRCLES_MEMBER_GROUPING = [
	{
		...
		label: t('circles', 'users'),
		labelStandalone: t('circles', 'Users'),
		share: ShareType.User,
		type: MEMBER_TYPE_USER,
	},
	{
		id: `picker-${ShareType.Group}`,
		label: t('circles', 'groups'),
		labelStandalone: t('circles', 'Groups'),
		share: ShareType.Group,
		type: MEMBER_TYPE_GROUP,
	},
	{
		id: `picker-${ShareType.Remote}`,
		label: t('circles', 'federated users'),
		labelStandalone: t('circles', 'Federated users'),
	...
	// },
	{
		...
		label: t('circles', 'teams'),
		labelStandalone: t('circles', 'Teams'),
		share: ShareType.Team,
		type: MEMBER_TYPE_CIRCLE,
	},
	{
		id: `picker-${ShareType.Email}`,
		label: t('circles', 'email addresses'),
		labelStandalone: t('circles', 'Email addresses'),
	...
	{
		id: 'picker-contact',
		label: t('circles', 'contacts'),
		labelStandalone: t('circles', 'Contacts'),
		share: ShareType.Email,
