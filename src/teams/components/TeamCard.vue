...
<template>
	<RouterLink
		...
		<div class="team-card__head">
			...
			<span class="team-card__name">{{ team.displayName }}</span>
		</div>
		...
		<div class="team-card__footer">
			<ul class="team-card__members" :aria-label="t('circles', 'Members')">
				<li
				...
				<li v-if="team.memberCount > team.members.length" class="team-card__member-more">
					+{{ team.memberCount - team.members.length }}
				</li>
			</ul>

			<span class="team-card__resources">
